...
{//   Item                      1+  11+  21+  31+  41+  51+  61+  71+  81+  91+   Levels
    ...
    { ITEM_ESCAPE_ROPE,      {   _,   3,   3,   4,   4,   4,   4,   5,   9,  10, } },
    { ITEM_ULTRA_BALL,       {   _,   3,   3,   4,   4,   4,   4,   5,   9,  10, } },
    ...
    { ITEM_STAR_PIECE,       {   _,   _,   1,   1,   1,   1,   1,   1,   1,   1, } },
    { ITEM_PEARL_STRING,     {   _,   _,   1,   1,   1,   1,   1,   1,   1,   1, } },
    { ITEM_COMET_SHARD,      {   _,   _,   1,   1,   1,   1,   1,   1,   1,   1, } },
    { ITEM_ELIXIR,      {   _,   _,   1,   1,   1,   1,   1,   1,   1,   1, } },
    { ITEM_BALM_MUSHROOM,   {   _,   _,   1,   4,   4,   4,   4,   5,   4,   5, } },
    { ITEM_MAX_REVIVE,      {   _,   _,   _,   4,   4,   4,   4,   7,   9,   9, } },
    { ITEM_BIG_NUGGET,          {   _,   _,   _,   _,   1,   1,   4,   5,   4,   5, } },
    { ITEM_LEFTOVERS,      {   _,   _,   _,   _,   _,   _,   1,   1,   4,   5, } },
    { ITEM_WHITE_HERB,      {   _,   _,   _,   _,   _,   _,   _,   1,   1,   1, } },
};
    ...
    else
    {
        ...
        else
        {
            ...
            case MOVE_EFFECT_TRIPLE_ARROWS:
                {
                    u8 randomLowerDefenseChance = RandomPercentage(RNG_TRIPLE_ARROWS_DEFENSE_DOWN, CalcSecondaryEffectChance(gBattlerAttacker, 30, EFFECT_DEFENSE_DOWN_HIT));
                    u8 randomFlinchChance = RandomPercentage(RNG_TRIPLE_ARROWS_FLINCH, CalcSecondaryEffectChance(gBattlerAttacker, 20, EFFECT_FLINCH_HIT));
        ...
        if (gBattleControllerExecFlags == 0)
        {
             ...
             || GetMonData(&gPlayerParty[*expMonId], MON_DATA_SPECIES_OR_EGG) == SPECIES_EGG)
            {
                ...
                gBattleMoveDamage = 0; // used for exp
                  ...
                  || !isUnderLevelCap(GetMonData(&gPlayerParty[*expMonId], MON_DATA_LEVEL)))
            {
                gBattleScripting.getexpState = 5;
                gBattleMoveDamage = 0; // used for exp
