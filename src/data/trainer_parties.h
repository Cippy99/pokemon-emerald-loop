...
static const struct TrainerMon sParty_RoxanneGym1[] = {
    ...
    .moves = {MOVE_WATER_GUN, MOVE_SMACK_DOWN, MOVE_HARDEN, MOVE_SCRATCH}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .moves = {MOVE_ACID, MOVE_ROCK_TOMB, MOVE_ASTONISH, MOVE_CONSTRICT}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
...
static const struct TrainerMon sParty_BrawlyGym1[] = {
    ...
    .moves = {MOVE_MEGA_DRAIN, MOVE_LEECH_SEED, MOVE_TACKLE, MOVE_STUN_SPORE}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .moves = {MOVE_CONFUSION, MOVE_MEDITATE, MOVE_LOW_KICK, MOVE_DETECT}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .moves = {MOVE_FORCE_PALM, MOVE_BULK_UP, MOVE_TACKLE, MOVE_SAND_ATTACK}
    }
...
static const struct TrainerMon sParty_WattsonGym1[] = {
    ...
    .species = SPECIES_MAGNEMITE,
    .ability = ABILITY_STURDY,
    .moves = {MOVE_THUNDER_SHOCK, MOVE_MAGNET_BOMB, MOVE_SUPERSONIC, MOVE_TACKLE}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .moves = {MOVE_THUNDER_SHOCK, MOVE_TACKLE, MOVE_ROLLOUT, MOVE_BULLET_SEED}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_ELECTRIKE,
    .ability = ABILITY_STATIC,
    .moves = {MOVE_SPARK, MOVE_HOWL, MOVE_QUICK_ATTACK, MOVE_THUNDER_WAVE}
    }
};
...
static const struct TrainerMon sParty_FlanneryGym1[] = {
    ...
    .moves = {MOVE_EMBER, MOVE_WORK_UP, MOVE_HEADBUTT, MOVE_LEER}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .moves = {MOVE_EMBER, MOVE_ROCK_THROW, MOVE_SMOG, MOVE_YAWN}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .moves = {MOVE_INCINERATE, MOVE_MAGNITUDE, MOVE_TACKLE, MOVE_FOCUS_ENERGY}
    }
};
...
static const struct TrainerMon sParty_NormanGym1[] = {
    ...
    .moves = {MOVE_HEADBUTT, MOVE_BABY_DOLL_EYES, MOVE_TAIL_WHIP, MOVE_SAND_ATTACK}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .moves = {MOVE_SCRATCH, MOVE_SLACK_OFF, MOVE_YAWN, MOVE_TICKLE}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .moves = {MOVE_ECHOED_VOICE, MOVE_DISARMING_VOICE, MOVE_FAKE_TEARS, MOVE_POUND}
    }
};
...
static const struct TrainerMon sParty_WinonaGym1[] = {
    ...
    .moves = {MOVE_WING_ATTACK, MOVE_QUICK_ATTACK, MOVE_FOCUS_ENERGY, MOVE_GROWL}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .moves = {MOVE_PLUCK, MOVE_DISARMING_VOICE, MOVE_SING, MOVE_ASTONISH}
    }
};
...
static const struct TrainerMon sParty_TateGym1[] = {
    ...
    .moves = {MOVE_CONFUSION, MOVE_DISARMING_VOICE, MOVE_DOUBLE_TEAM, MOVE_HYPNOSIS}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .moves = {MOVE_PSYWAVE, MOVE_PLUCK, MOVE_CONSTRICT, MOVE_SWAGGER}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .moves = {MOVE_CONFUSION, MOVE_RAPID_SPIN, MOVE_MUD_SLAP, MOVE_ROCK_TOMB}
    }
};
...
static const struct TrainerMon sParty_JuanGym1[] = {
    ...
    .moves = {MOVE_WATER_GUN, MOVE_MUD_BOMB, MOVE_MUD_SLAP, MOVE_MUD_SPORT}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .moves = {MOVE_AQUA_JET, MOVE_LEER, MOVE_HARDEN, MOVE_VISE_GRIP}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .moves = {MOVE_WHIRLPOOL, MOVE_IRON_DEFENSE, MOVE_SUPERSONIC, MOVE_AQUA_RING}
    }
};
...
static const struct TrainerMon sParty_SidneyGym1[] = {
    ...
    .moves = {MOVE_BITE, MOVE_FOCUS_ENERGY, MOVE_AQUA_JET, MOVE_LEER}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .moves = {MOVE_THIEF, MOVE_GROWTH, MOVE_RAZOR_LEAF, MOVE_POUND}
    }
};
...
static const struct TrainerMon sParty_PhoebeGym1[] = {
    ...
    .moves = {MOVE_ASTONISH, MOVE_CONFUSE_RAY, MOVE_BRANCH_POKE, MOVE_INGRAIN}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .moves = {MOVE_NIGHT_SHADE, MOVE_SHADOW_SNEAK, MOVE_SCREECH, MOVE_SPITE}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_DUSKULL,
    .ability = ABILITY_LEVITATE,
    .moves = {MOVE_NIGHT_SHADE, MOVE_SHADOW_SNEAK, MOVE_CONFUSE_RAY, MOVE_FEINT_ATTACK}
    }
};
...
static const struct TrainerMon sParty_GlaciaGym1[] = {
    ...
    .moves = {MOVE_AVALANCHE, MOVE_TAUNT, MOVE_BITE, MOVE_TACKLE}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .moves = {MOVE_ICY_WIND, MOVE_DOUBLE_TEAM, MOVE_ASTONISH, MOVE_ICE_SHARD}
    }
};
...
static const struct TrainerMon sParty_DrakeGym1[] = {
    ...
    .moves = {MOVE_SAND_TOMB, MOVE_BULLDOZE, MOVE_BITE, MOVE_MUD_SLAP}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .moves = {MOVE_DRAGON_BREATH, MOVE_EMBER, MOVE_BITE, MOVE_HEADBUTT}
    }
};
...
static const struct TrainerMon sParty_ValerieGym1[] = {
    ...
    .ability = ABILITY_EFFECT_SPORE,
    .moves = {MOVE_MEGA_DRAIN, MOVE_CONFUSE_RAY, MOVE_GROWTH, MOVE_MOONLIGHT}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .moves = {MOVE_CONFUSION, MOVE_COPYCAT, MOVE_DOUBLE_SLAP, MOVE_CHARM}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .moves = {MOVE_DISARMING_VOICE, MOVE_SING, MOVE_MINIMIZE, MOVE_DOUBLE_SLAP}
    }
};
...
static const struct TrainerMon sParty_RoxanneGym2[] = {
    ...
    .species = SPECIES_ANORITH,
    .ability = ABILITY_BATTLE_ARMOR,
    .moves = {MOVE_FURY_CUTTER, MOVE_SMACK_DOWN, MOVE_HARDEN, MOVE_METAL_CLAW}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_LILEEP,
    .ability = ABILITY_STORM_DRAIN,
    .moves = {MOVE_ACID, MOVE_ANCIENT_POWER, MOVE_INGRAIN, MOVE_CONSTRICT}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
...
static const struct TrainerMon sParty_BrawlyGym2[] = {
    ...
    .species = SPECIES_SHROOMISH,
    .ability = ABILITY_EFFECT_SPORE,
    .moves = {MOVE_MEGA_DRAIN, MOVE_LEECH_SEED, MOVE_HEADBUTT, MOVE_STUN_SPORE}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_MEDITITE,
    .ability = ABILITY_PURE_POWER,
    .moves = {MOVE_CONFUSION, MOVE_MEDITATE, MOVE_FORCE_PALM, MOVE_DETECT}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_MAKUHITA,
    .ability = ABILITY_GUTS,
    .moves = {MOVE_FORCE_PALM, MOVE_BULK_UP, MOVE_TACKLE, MOVE_KNOCK_OFF}
    }
...
static const struct TrainerMon sParty_WattsonGym2[] = {
    ...
    .species = SPECIES_MAGNEMITE,
    .ability = ABILITY_STURDY,
    .moves = {MOVE_THUNDER_SHOCK, MOVE_MAGNET_BOMB, MOVE_SUPERSONIC, MOVE_THUNDER_WAVE}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_VOLTORB_HISUIAN,
    .ability = ABILITY_STATIC,
    .moves = {MOVE_CHARGE_BEAM, MOVE_TACKLE, MOVE_ROLLOUT, MOVE_BULLET_SEED}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_ELECTRIKE,
    .ability = ABILITY_STATIC,
    .moves = {MOVE_THUNDER_FANG, MOVE_BITE, MOVE_QUICK_ATTACK, MOVE_THUNDER_WAVE}
    }
};
...
static const struct TrainerMon sParty_FlanneryGym2[] = {
    ...
    .species = SPECIES_LITLEO,
    .ability = ABILITY_RIVALRY,
    .moves = {MOVE_EMBER, MOVE_WORK_UP, MOVE_HEADBUTT, MOVE_NOBLE_ROAR}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_SLUGMA,
    .ability = ABILITY_FLAME_BODY,
    .moves = {MOVE_INCINERATE, MOVE_ROCK_THROW, MOVE_SMOG, MOVE_YAWN}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_NUMEL,
    .ability = ABILITY_OWN_TEMPO,
    .moves = {MOVE_FLAME_BURST, MOVE_BULLDOZE, MOVE_AMNESIA, MOVE_FOCUS_ENERGY}
    }
};
...
static const struct TrainerMon sParty_NormanGym2[] = {
    ...
    .species = SPECIES_ZIGZAGOON,
    .ability = ABILITY_QUICK_FEET,
    .moves = {MOVE_HEADBUTT, MOVE_BABY_DOLL_EYES, MOVE_PIN_MISSILE, MOVE_SAND_ATTACK}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_VIGOROTH,
    .ability = ABILITY_TRUANT,
    .moves = {MOVE_FURY_SWIPES, MOVE_SLACK_OFF, MOVE_YAWN, MOVE_FEINT_ATTACK}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_LOUDRED,
    .ability = ABILITY_SOUNDPROOF,
    .moves = {MOVE_ECHOED_VOICE, MOVE_DISARMING_VOICE, MOVE_BITE, MOVE_SUPERSONIC}
    }
};
...
static const struct TrainerMon sParty_WinonaGym2[] = {
    ...
    .species = SPECIES_WINGULL,
    .ability = ABILITY_KEEN_EYE,
    .moves = {MOVE_WATER_PULSE, MOVE_WING_ATTACK, MOVE_SUPERSONIC, MOVE_GROWL}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .moves = {MOVE_WING_ATTACK, MOVE_DOUBLE_TEAM, MOVE_QUICK_ATTACK, MOVE_ENDEAVOR}
    }
};
...
static const struct TrainerMon sParty_TateGym2[] = {
    ...
    .species = SPECIES_BALTOY,
    .ability = ABILITY_LEVITATE,
    .moves = {MOVE_PSYBEAM, MOVE_RAPID_SPIN, MOVE_MUD_SLAP, MOVE_ANCIENT_POWER}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_KIRLIA,
    .ability = ABILITY_SYNCHRONIZE,
    .moves = {MOVE_PSYBEAM, MOVE_DISARMING_VOICE, MOVE_MAGICAL_LEAF, MOVE_HYPNOSIS}
    }
};
...
static const struct TrainerMon sParty_JuanGym2[] = {
    ...
    .species = SPECIES_BARBOACH,
    .ability = ABILITY_HYDRATION,
    .moves = {MOVE_WATER_PULSE, MOVE_MUD_BOMB, MOVE_MUD_SLAP, MOVE_MUD_SPORT}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_CORPHISH,
    .ability = ABILITY_ADAPTABILITY,
    .moves = {MOVE_AQUA_JET, MOVE_BUBBLE_BEAM, MOVE_HARDEN, MOVE_KNOCK_OFF}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_LOMBRE,
    .ability = ABILITY_OWN_TEMPO,
    .moves = {MOVE_WATER_PULSE, MOVE_FAKE_OUT, MOVE_FURY_SWIPES, MOVE_MEGA_DRAIN}
    }
};
...
static const struct TrainerMon sParty_SidneyGym2[] = {
    ...
    .species = SPECIES_MIGHTYENA,
    .ability = ABILITY_INTIMIDATE,
    .moves = {MOVE_BITE, MOVE_HOWL, MOVE_TACKLE, MOVE_MUD_SLAP}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_CARVANHA,
    .ability = ABILITY_ROUGH_SKIN,
    .moves = {MOVE_BITE, MOVE_FOCUS_ENERGY, MOVE_AQUA_JET, MOVE_FLIP_TURN}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_NUZLEAF,
    .ability = ABILITY_EARLY_BIRD,
    .moves = {MOVE_THIEF, MOVE_GROWTH, MOVE_RAZOR_LEAF, MOVE_NATURE_POWER}
    }
};
...
static const struct TrainerMon sParty_PhoebeGym2[] = {
    ...
    .species = SPECIES_PHANTUMP,
    .ability = ABILITY_HARVEST,
    .moves = {MOVE_ASTONISH, MOVE_CONFUSE_RAY, MOVE_BRANCH_POKE, MOVE_LEECH_SEED}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_SHUPPET,
    .ability = ABILITY_CURSED_BODY,
    .moves = {MOVE_NIGHT_SHADE, MOVE_SHADOW_SNEAK, MOVE_KNOCK_OFF, MOVE_WILL_O_WISP}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_DUSKULL,
    .ability = ABILITY_LEVITATE,
    .moves = {MOVE_NIGHT_SHADE, MOVE_SHADOW_SNEAK, MOVE_CONFUSE_RAY, MOVE_PAYBACK}
    }
};
...
static const struct TrainerMon sParty_GlaciaGym2[] = {
    ...
    .species = SPECIES_SPHEAL,
    .ability = ABILITY_THICK_FAT,
    .moves = {MOVE_ICE_BALL, MOVE_BRINE, MOVE_ROLLOUT, MOVE_DEFENSE_CURL}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_SNORUNT,
    .ability = ABILITY_MOODY,
    .moves = {MOVE_ICY_WIND, MOVE_DOUBLE_TEAM, MOVE_BITE, MOVE_ICE_SHARD}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .moves = {MOVE_ICE_SHARD, MOVE_FAKE_OUT, MOVE_CONFUSION, MOVE_CHARM}
    }
};
...
static const struct TrainerMon sParty_DrakeGym2[] = {
    ...
    .species = SPECIES_TRAPINCH,
    .ability = ABILITY_HYPER_CUTTER,
    .moves = {MOVE_SAND_TOMB, MOVE_BULLDOZE, MOVE_BITE, MOVE_ROCK_SLIDE}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_SKRELP,
    .ability = ABILITY_POISON_POINT,
    .moves = {MOVE_WATER_PULSE, MOVE_ACID, MOVE_FEINT_ATTACK, MOVE_SMOKESCREEN}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
...
static const struct TrainerMon sParty_ValerieGym2[] = {
    ...
    .species = SPECIES_MORELULL,
    .ability = ABILITY_EFFECT_SPORE,
    .moves = {MOVE_MEGA_DRAIN, MOVE_SLEEP_POWDER, MOVE_GROWTH, MOVE_MOONLIGHT}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_CLEFAIRY,
    .ability = ABILITY_CUTE_CHARM,
    .moves = {MOVE_DISARMING_VOICE, MOVE_METRONOME, MOVE_MINIMIZE, MOVE_DOUBLE_SLAP}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_MIME_JR,
    .ability = ABILITY_FILTER,
    .moves = {MOVE_CONFUSION, MOVE_FAKE_OUT, MOVE_DOUBLE_SLAP, MOVE_CHARM}
    }    
};
...
static const struct TrainerMon sParty_ErikaGym2[] = {
    ...
    .species = SPECIES_BELLSPROUT,
    .ability = ABILITY_CHLOROPHYLL,
    .moves = {MOVE_BULLET_SEED, MOVE_GROWTH, MOVE_SLEEP_POWDER, MOVE_WRAP}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
...
static const struct TrainerMon sParty_GiovanniGym2[] = {
    ...
    .species = SPECIES_CUBONE,
    .ability = ABILITY_BATTLE_ARMOR,
    .moves = {MOVE_BONE_CLUB, MOVE_HEADBUTT, MOVE_TAIL_WHIP, MOVE_FOCUS_ENERGY}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_DIGLETT,
    .ability = ABILITY_ARENA_TRAP,
    .moves = {MOVE_BULLDOZE, MOVE_SCRATCH, MOVE_PURSUIT, MOVE_SAND_ATTACK}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_RHYHORN,
    .ability = ABILITY_ROCK_HEAD,
    .moves = {MOVE_BULLDOZE, MOVE_ROCK_TOMB, MOVE_TAIL_WHIP, MOVE_HORN_ATTACK}
    }
};
...
static const struct TrainerMon sParty_KogaGym2[] = {
    ...
    .species = SPECIES_KOFFING,
    .ability = ABILITY_LEVITATE,
    .moves = {MOVE_SLUDGE, MOVE_TACKLE, MOVE_POISON_GAS, MOVE_ASSURANCE}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_ZUBAT,
    .ability = ABILITY_INNER_FOCUS,
    .moves = {MOVE_POISON_FANG, MOVE_WING_ATTACK, MOVE_BITE, MOVE_CONFUSE_RAY}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_GRIMER,
    .ability = ABILITY_POISON_TOUCH,
    .moves = {MOVE_SLUDGE, MOVE_MUD_BOMB, MOVE_DISABLE, MOVE_POUND}
    }
};
...
static const struct TrainerMon sParty_BugsyGym2[] = {
    ...
    .species = SPECIES_PARAS,
    .ability = ABILITY_EFFECT_SPORE,
    .moves = {MOVE_MEGA_DRAIN, MOVE_STUN_SPORE, MOVE_BUG_BITE, MOVE_SCRATCH}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_DEWPIDER,
    .ability = ABILITY_WATER_BUBBLE,
    .moves = {MOVE_BUBBLE_BEAM, MOVE_INFESTATION, MOVE_BUG_BITE, MOVE_AQUA_RING}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_VENONAT,
    .ability = ABILITY_TINTED_LENS,
    .moves = {MOVE_POUNCE, MOVE_PSYBEAM, MOVE_SUPERSONIC, MOVE_TACKLE}
    }
};
...
static const struct TrainerMon sParty_StevenGym2[] = {
    ...
    .species = SPECIES_FERROSEED,
    .ability = ABILITY_IRON_BARBS,
    .moves = {MOVE_METAL_CLAW, MOVE_CURSE, MOVE_LEECH_SEED, MOVE_PIN_MISSILE}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .ability = ABILITY_CLEAR_BODY,
    .moves = {MOVE_TAKE_DOWN, MOVE_IRON_DEFENSE, MOVE_CONFUSION, MOVE_METAL_CLAW}
    }
};

// Gym 3

static const struct TrainerMon sParty_RoxanneGym3[] = {
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    .iv = TRAINER_PARTY_IVS(15, 15 ,15 ,15 ,15 ,15),
    ...
    .species = SPECIES_ANORITH,
    .ability = ABILITY_BATTLE_ARMOR,
    .moves = {MOVE_BUG_BITE, MOVE_SMACK_DOWN, MOVE_ANCIENT_POWER, MOVE_METAL_CLAW}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_LILEEP,
    .ability = ABILITY_STORM_DRAIN,
    .moves = {MOVE_BRINE, MOVE_ANCIENT_POWER, MOVE_MEGA_DRAIN, MOVE_CONSTRICT}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .ability = ABILITY_STURDY,
    .moves = {MOVE_HEADBUTT, MOVE_ROCK_TOMB, MOVE_IRON_DEFENSE, MOVE_POWER_GEM}
    }
};

static const struct TrainerMon sParty_NormanGym3[] = {
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    .iv = TRAINER_PARTY_IVS(15, 15 ,15 ,15 ,15 ,15),
    ...
    .species = SPECIES_LINOONE,
    .ability = ABILITY_QUICK_FEET,
    .moves = {MOVE_HEADBUTT, MOVE_CHARM, MOVE_PIN_MISSILE, MOVE_PURSUIT}
    }
};

static const struct TrainerMon sParty_BrawlyGym3[] = {
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    .iv = TRAINER_PARTY_IVS(15, 15 ,15 ,15 ,15 ,15),
    ...
    .species = SPECIES_BRELOOM,
    .ability = ABILITY_EFFECT_SPORE,
    .moves = {MOVE_MEGA_DRAIN, MOVE_LEECH_SEED, MOVE_HEADBUTT, MOVE_MACH_PUNCH}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_MEDITITE,
    .ability = ABILITY_PURE_POWER,
    .moves = {MOVE_PSYBEAM, MOVE_BULK_UP, MOVE_FORCE_PALM, MOVE_BULLET_PUNCH}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_HARIYAMA,
    .ability = ABILITY_GUTS,
    .moves = {MOVE_FORCE_PALM, MOVE_BULK_UP, MOVE_BRINE, MOVE_KNOCK_OFF}
    }
};

static const struct TrainerMon sParty_WattsonGym3[] = {
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    .iv = TRAINER_PARTY_IVS(15, 15 ,15 ,15 ,15 ,15),
    ...
    .species = SPECIES_MAGNEMITE,
    .ability = ABILITY_STURDY,
    .moves = {MOVE_SHOCK_WAVE, MOVE_MIRROR_SHOT, MOVE_THUNDER_WAVE, MOVE_SONIC_BOOM}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_VOLTORB_HISUIAN,
    .ability = ABILITY_STATIC,
    .moves = {MOVE_CHARGE_BEAM, MOVE_SHOCK_WAVE, MOVE_ROLLOUT, MOVE_BULLET_SEED}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_MANECTRIC,
    .ability = ABILITY_STATIC,
    .moves = {MOVE_THUNDER_FANG, MOVE_QUICK_ATTACK, MOVE_BITE, MOVE_SHOCK_WAVE}
    }
};

static const struct TrainerMon sParty_FlanneryGym3[] = {
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    .iv = TRAINER_PARTY_IVS(15, 15 ,15 ,15 ,15 ,15),
    ...
    .species = SPECIES_LITLEO,
    .ability = ABILITY_RIVALRY,
    .moves = {MOVE_INCINERATE, MOVE_SWIFT, MOVE_HEADBUTT, MOVE_SUNNY_DAY}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
...
static const struct TrainerMon sParty_WinonaGym3[] = {
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    .iv = TRAINER_PARTY_IVS(15, 15 ,15 ,15 ,15 ,15),
    ...
    .species = SPECIES_WINGULL,
    .ability = ABILITY_KEEN_EYE,
    .moves = {MOVE_WATER_PULSE, MOVE_AIR_CUTTER, MOVE_SUPERSONIC, MOVE_QUICK_ATTACK}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_SWELLOW,
    .ability = ABILITY_SCRAPPY,
    .moves = {MOVE_AERIAL_ACE, MOVE_QUICK_ATTACK, MOVE_STEEL_WING, MOVE_DOUBLE_TEAM}
    }
};

static const struct TrainerMon sParty_TateGym3[] = {
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    .iv = TRAINER_PARTY_IVS(15, 15 ,15 ,15 ,15 ,15),
    ...
    .species = SPECIES_BALTOY,
    .ability = ABILITY_LEVITATE,
    .moves = {MOVE_PSYBEAM, MOVE_RAPID_SPIN, MOVE_SIGNAL_BEAM, MOVE_ANCIENT_POWER}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_KIRLIA,
    .ability = ABILITY_SYNCHRONIZE,
    .moves = {MOVE_PSYBEAM, MOVE_DRAINING_KISS, MOVE_MAGICAL_LEAF, MOVE_HYPNOSIS}
    }
};

static const struct TrainerMon sParty_JuanGym3[] = {
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    .iv = TRAINER_PARTY_IVS(15, 15 ,15 ,15 ,15 ,15),
    ...
    .species = SPECIES_BARBOACH,
    .ability = ABILITY_HYDRATION,
    .moves = {MOVE_WATER_PULSE, MOVE_MUD_BOMB, MOVE_MUD_SLAP, MOVE_MAGNITUDE}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_CORPHISH,
    .ability = ABILITY_ADAPTABILITY,
    .moves = {MOVE_AQUA_JET, MOVE_BUBBLE_BEAM, MOVE_DOUBLE_HIT, MOVE_KNOCK_OFF}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_LOMBRE,
    .ability = ABILITY_OWN_TEMPO,
    .moves = {MOVE_BUBBLE_BEAM, MOVE_FAKE_OUT, MOVE_SYNTHESIS, MOVE_GIGA_DRAIN}
    }
};

static const struct TrainerMon sParty_SidneyGym3[] = {
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    .iv = TRAINER_PARTY_IVS(15, 15 ,15 ,15 ,15 ,15),
    ...
    .species = SPECIES_NUZLEAF,
    .ability = ABILITY_CHLOROPHYLL,
    .moves = {MOVE_FEINT_ATTACK, MOVE_FAKE_OUT, MOVE_RAZOR_LEAF, MOVE_NATURE_POWER}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_CARVANHA,
    .ability = ABILITY_ROUGH_SKIN,
    .moves = {MOVE_BITE, MOVE_ICE_FANG, MOVE_AQUA_JET, MOVE_FLIP_TURN}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_MIGHTYENA,
    .ability = ABILITY_INTIMIDATE,
    .moves = {MOVE_BITE, MOVE_HOWL, MOVE_TACKLE, MOVE_FIRE_FANG}
    }
};

static const struct TrainerMon sParty_PhoebeGym3[] = {
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    .iv = TRAINER_PARTY_IVS(15, 15 ,15 ,15 ,15 ,15),
    ...
    .species = SPECIES_PHANTUMP,
    .ability = ABILITY_HARVEST,
    .moves = {MOVE_HEX, MOVE_CONFUSE_RAY, MOVE_MAGICAL_LEAF, MOVE_LEECH_SEED}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_DUSKULL,
    .ability = ABILITY_LEVITATE,
    .moves = {MOVE_NIGHT_SHADE, MOVE_SHADOW_SNEAK, MOVE_WILL_O_WISP, MOVE_PAYBACK}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .moves = {MOVE_SHADOW_SNEAK, MOVE_FAKE_OUT, MOVE_FURY_SWIPES, MOVE_FEINT_ATTACK}
    }
};

static const struct TrainerMon sParty_GlaciaGym3[] = {
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    .iv = TRAINER_PARTY_IVS(15, 15 ,15 ,15 ,15 ,15),
    ...
    .species = SPECIES_SPHEAL,
    .ability = ABILITY_THICK_FAT,
    .moves = {MOVE_AURORA_BEAM, MOVE_BRINE, MOVE_ROLLOUT, MOVE_YAWN}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_SNORUNT,
    .ability = ABILITY_MOODY,
    .moves = {MOVE_ICY_WIND, MOVE_WATER_PULSE, MOVE_BITE, MOVE_ICE_SHARD}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_MR_MIME_GALARIAN,
    .ability = ABILITY_VITAL_SPIRIT,
    .moves = {MOVE_ICY_WIND, MOVE_FAKE_OUT, MOVE_CONFUSION, MOVE_DOUBLE_KICK}
    }
};

static const struct TrainerMon sParty_ErikaGym3[] = {
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    .iv = TRAINER_PARTY_IVS(15, 15 ,15 ,15 ,15 ,15),
    ...
    .ability = ABILITY_CHLOROPHYLL,
    .moves = {MOVE_BULLET_SEED, MOVE_GROWTH, MOVE_SLEEP_POWDER, MOVE_VENOSHOCK}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_GLOOM,
    .ability = ABILITY_CHLOROPHYLL,
    .moves = {MOVE_GIGA_DRAIN, MOVE_GROWTH, MOVE_ACID, MOVE_SLEEP_POWDER}
    }
};

static const struct TrainerMon sParty_DrakeGym3[] = {
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    .iv = TRAINER_PARTY_IVS(15, 15 ,15 ,15 ,15 ,15),
    ...
    .species = SPECIES_TRAPINCH,
    .ability = ABILITY_HYPER_CUTTER,
    .moves = {MOVE_SAND_TOMB, MOVE_BULLDOZE, MOVE_CRUNCH, MOVE_ROCK_SLIDE}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_SKRELP,
    .ability = ABILITY_POISON_POINT,
    .moves = {MOVE_WATER_PULSE, MOVE_POISON_TAIL, MOVE_FEINT_ATTACK, MOVE_SMOKESCREEN}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_SHELGON,
    .ability = ABILITY_ROCK_HEAD,
    .moves = {MOVE_DRAGON_BREATH, MOVE_EMBER, MOVE_CRUNCH, MOVE_HEADBUTT}
    }
};

static const struct TrainerMon sParty_GiovanniGym3[] = {
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    .iv = TRAINER_PARTY_IVS(15, 15 ,15 ,15 ,15 ,15),
    ...
    .species = SPECIES_CUBONE,
    .ability = ABILITY_BATTLE_ARMOR,
    .moves = {MOVE_BONEMERANG, MOVE_HEADBUTT, MOVE_DOUBLE_KICK, MOVE_ROCK_TOMB}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_RHYHORN,
    .ability = ABILITY_ROCK_HEAD,
    .moves = {MOVE_ROCK_TOMB, MOVE_BULLDOZE, MOVE_TAIL_WHIP, MOVE_STOMP}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .ability = ABILITY_POISON_POINT,
    .moves = {MOVE_POISON_TAIL, MOVE_STOMPING_TANTRUM, MOVE_DOUBLE_KICK, MOVE_HORN_ATTACK}
    }
};

static const struct TrainerMon sParty_KogaGym3[] = {
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    .iv = TRAINER_PARTY_IVS(15, 15 ,15 ,15 ,15 ,15),
    ...
    .species = SPECIES_KOFFING,
    .ability = ABILITY_LEVITATE,
    .moves = {MOVE_SLUDGE, MOVE_SELF_DESTRUCT, MOVE_POISON_GAS, MOVE_ASSURANCE}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_GRIMER,
    .ability = ABILITY_POISON_TOUCH,
    .moves = {MOVE_SLUDGE, MOVE_MUD_BOMB, MOVE_MINIMIZE, MOVE_HEADBUTT}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
...
static const struct TrainerMon sParty_StevenGym3[] = {
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    .iv = TRAINER_PARTY_IVS(15, 15 ,15 ,15 ,15 ,15),
    ...
    .species = SPECIES_ARON,
    .ability = ABILITY_STURDY,
    .moves = {MOVE_ROCK_TOMB, MOVE_IRON_HEAD, MOVE_HEADBUTT, MOVE_MUD_SLAP}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_METANG,
    .ability = ABILITY_CLEAR_BODY,
    .moves = {MOVE_TAKE_DOWN, MOVE_FLASH_CANNON, MOVE_CONFUSION, MOVE_METAL_CLAW}
    }
};

static const struct TrainerMon sParty_BugsyGym3[] = {
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    .iv = TRAINER_PARTY_IVS(15, 15 ,15 ,15 ,15 ,15),
    ...
    .species = SPECIES_PARAS,
    .ability = ABILITY_EFFECT_SPORE,
    .moves = {MOVE_MEGA_DRAIN, MOVE_SPORE, MOVE_BUG_BITE, MOVE_SCRATCH}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_VENONAT,
    .ability = ABILITY_TINTED_LENS,
    .moves = {MOVE_POUNCE, MOVE_PSYBEAM, MOVE_STUN_SPORE, MOVE_BUG_BITE}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .moves = {MOVE_FURY_CUTTER, MOVE_AGILITY, MOVE_FOCUS_ENERGY, MOVE_QUICK_ATTACK}
    }
};

static const struct TrainerMon sParty_ValerieGym3[] = {
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    .iv = TRAINER_PARTY_IVS(15, 15 ,15 ,15 ,15 ,15),
    ...
    .species = SPECIES_CLEFAIRY,
    .ability = ABILITY_CUTE_CHARM,
    .moves = {MOVE_DISARMING_VOICE, MOVE_METRONOME, MOVE_MINIMIZE, MOVE_WAKE_UP_SLAP}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .ability = ABILITY_FILTER,
    .moves = {MOVE_CONFUSION, MOVE_FAKE_OUT, MOVE_ICY_WIND, MOVE_REFLECT}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .ability = ABILITY_EFFECT_SPORE,
    .moves = {MOVE_MEGA_DRAIN, MOVE_SLEEP_POWDER, MOVE_GROWTH, MOVE_DRAINING_KISS}
    }
};

// Gym 4

static const struct TrainerMon sParty_RoxanneGym4[] = {
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_ANORITH,
    .ability = ABILITY_BATTLE_ARMOR,
    .moves = {MOVE_BUG_BITE, MOVE_ROCK_SLIDE, MOVE_ANCIENT_POWER, MOVE_METAL_CLAW}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_LILEEP,
    .ability = ABILITY_STORM_DRAIN,
    .moves = {MOVE_BRINE, MOVE_ANCIENT_POWER, MOVE_GIGA_DRAIN, MOVE_CONSTRICT}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .ability = ABILITY_STURDY,
    .moves = {MOVE_ANCIENT_POWER, MOVE_YAWN, MOVE_DIVE, MOVE_AMNESIA}
    }
};

static const struct TrainerMon sParty_NormanGym4[] = {
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    .iv = TRAINER_PARTY_IVS(20, 20 ,20 ,20 ,20 ,20),
    ...
    .species = SPECIES_LOUDRED,
    .ability = ABILITY_SOUNDPROOF,
    .moves = {MOVE_STOMP, MOVE_DISARMING_VOICE, MOVE_BITE, MOVE_SUPERSONIC}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_VIGOROTH,
    .ability = ABILITY_VITAL_SPIRIT,
    .moves = {MOVE_CHIP_AWAY, MOVE_SLACK_OFF, MOVE_YAWN, MOVE_FEINT_ATTACK}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .moves = {MOVE_HEADBUTT, MOVE_WATER_GUN, MOVE_ROLLOUT, MOVE_YAWN}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
...
static const struct TrainerMon sParty_BrawlyGym4[] = {
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    .iv = TRAINER_PARTY_IVS(20, 20 ,20 ,20 ,20 ,20),
    ...
    .moves = {MOVE_RAPID_SPIN, MOVE_COUNTER, MOVE_ROLLING_KICK, MOVE_FOCUS_ENERGY}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_HARIYAMA,
    .ability = ABILITY_GUTS,
    .moves = {MOVE_FORCE_PALM, MOVE_BULK_UP, MOVE_SMELLINGSALT, MOVE_KNOCK_OFF}
    }
};

static const struct TrainerMon sParty_WattsonGym4[] = {
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    .iv = TRAINER_PARTY_IVS(20, 20 ,20 ,20 ,20 ,20),
    ...
    .species = SPECIES_VOLTORB_HISUIAN,
    .ability = ABILITY_STATIC,
    .moves = {MOVE_ELECTRO_BALL, MOVE_SHOCK_WAVE, MOVE_SWIFT, MOVE_BULLET_SEED}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .moves = {MOVE_BUBBLE_BEAM, MOVE_SPARK, MOVE_CHARGE, MOVE_PIN_MISSILE}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_MANECTRIC,
    .ability = ABILITY_STATIC,
    .moves = {MOVE_THUNDER_FANG, MOVE_QUICK_ATTACK, MOVE_BITE, MOVE_DISCHARGE}
    }
};

static const struct TrainerMon sParty_FlanneryGym4[] = {
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    .iv = TRAINER_PARTY_IVS(20, 20 ,20 ,20 ,20 ,20),
    ...
    .moves = {MOVE_LAVA_PLUME, MOVE_BODY_SLAM, MOVE_SUNNY_DAY, MOVE_ATTRACT}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .moves = {MOVE_FLAME_BURST, MOVE_ANCIENT_POWER, MOVE_SUNNY_DAY, MOVE_CLEAR_SMOG}
    }
};

static const struct TrainerMon sParty_WinonaGym4[] = {
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    .iv = TRAINER_PARTY_IVS(20, 20 ,20 ,20 ,20 ,20),
    ...
    .species = SPECIES_SWABLU,
    .ability = ABILITY_NATURAL_CURE,
    .moves = {MOVE_PLUCK, MOVE_ROUND, MOVE_SING, MOVE_DRAGON_BREATH}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_STARAVIA,
    .ability = ABILITY_INTIMIDATE,
    .moves = {MOVE_AERIAL_ACE, MOVE_DOUBLE_TEAM, MOVE_QUICK_ATTACK, MOVE_ENDEAVOR}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_PELIPPER,
    .ability = ABILITY_KEEN_EYE,
    .moves = {MOVE_WATER_PULSE, MOVE_AIR_CUTTER, MOVE_SUPERSONIC, MOVE_PAYBACK}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
...
static const struct TrainerMon sParty_TateGym4[] = {
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    .iv = TRAINER_PARTY_IVS(20, 20 ,20 ,20 ,20 ,20),
    ...
    .species = SPECIES_BALTOY,
    .ability = ABILITY_LEVITATE,
    .moves = {MOVE_EXTRASENSORY, MOVE_RAPID_SPIN, MOVE_SIGNAL_BEAM, MOVE_ANCIENT_POWER}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_KIRLIA,
    .ability = ABILITY_SYNCHRONIZE,
    .moves = {MOVE_PSYBEAM, MOVE_DRAINING_KISS, MOVE_MAGICAL_LEAF, MOVE_CALM_MIND}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_SOLROCK,
    .ability = ABILITY_LEVITATE,
    .moves = {MOVE_PSYCHIC, MOVE_FIRE_SPIN, MOVE_ROCK_SLIDE, MOVE_ROCK_POLISH}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .ability = ABILITY_CONTRARY,
    .moves = {MOVE_PSYCHO_CUT, MOVE_PLUCK, MOVE_PAYBACK, MOVE_SWAGGER}
    },
};

static const struct TrainerMon sParty_JuanGym4[] = {
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    .iv = TRAINER_PARTY_IVS(20, 20 ,20 ,20 ,20 ,20),
    ...
    .species = SPECIES_CLAMPERL,
    .ability = ABILITY_SHELL_ARMOR,
    .moves = {MOVE_WATER_PULSE, MOVE_CONFUSE_RAY, MOVE_ICY_WIND, MOVE_BODY_SLAM}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_WHISCASH,
    .ability = ABILITY_HYDRATION,
    .moves = {MOVE_WATER_PULSE, MOVE_MUD_BOMB, MOVE_AQUA_TAIL, MOVE_BELCH}
    },
};

static const struct TrainerMon sParty_SidneyGym4[] = {
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    .iv = TRAINER_PARTY_IVS(20, 20 ,20 ,20 ,20 ,20),
    ...
    .species = SPECIES_NUZLEAF,
    .ability = ABILITY_CHLOROPHYLL,
    .moves = {MOVE_FEINT_ATTACK, MOVE_FAKE_OUT, MOVE_LEAF_BLADE, MOVE_NATURE_POWER}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .moves = {MOVE_ASSURANCE, MOVE_SWIFT, MOVE_POWER_GEM, MOVE_PARTING_SHOT}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_MIGHTYENA,
    .ability = ABILITY_INTIMIDATE,
    .moves = {MOVE_BITE, MOVE_HOWL, MOVE_HEADBUTT, MOVE_FIRE_FANG}
    }
};

static const struct TrainerMon sParty_PhoebeGym4[] = {
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    .iv = TRAINER_PARTY_IVS(20, 20 ,20 ,20 ,20 ,20),
    ...
    .species = SPECIES_PHANTUMP,
    .ability = ABILITY_HARVEST,
    .moves = {MOVE_HEX, MOVE_CONFUSE_RAY, MOVE_HORN_LEECH, MOVE_LEECH_SEED}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_BANETTE,
    .ability = ABILITY_CURSED_BODY,
    .moves = {MOVE_HEX, MOVE_SHADOW_SNEAK, MOVE_WILL_O_WISP, MOVE_KNOCK_OFF}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_SABLEYE,
    .ability = ABILITY_MAGIC_BOUNCE,
    .moves = {MOVE_SHADOW_SNEAK, MOVE_FAKE_OUT, MOVE_FURY_SWIPES, MOVE_KNOCK_OFF}
    }
};

static const struct TrainerMon sParty_GlaciaGym4[] = {
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    .iv = TRAINER_PARTY_IVS(20, 20 ,20 ,20 ,20 ,20),
    ...
    .ability = ABILITY_HYPER_CUTTER,
    .moves = {MOVE_POWER_UP_PUNCH, MOVE_BUBBLE_BEAM, MOVE_BRICK_BREAK, MOVE_DIZZY_PUNCH}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_SNORUNT,
    .ability = ABILITY_MOODY,
    .moves = {MOVE_ICY_WIND, MOVE_WATER_PULSE, MOVE_BITE, MOVE_ICE_FANG}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_MR_MIME_GALARIAN,
    .ability = ABILITY_VITAL_SPIRIT,
    .moves = {MOVE_ICY_WIND, MOVE_FAKE_OUT, MOVE_PSYBEAM, MOVE_DOUBLE_KICK}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_SEALEO,
    .ability = ABILITY_THICK_FAT,
    .moves = {MOVE_AURORA_BEAM, MOVE_BRINE, MOVE_SWAGGER, MOVE_YAWN}
    },
};

static const struct TrainerMon sParty_ErikaGym4[] = {
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    .iv = TRAINER_PARTY_IVS(20, 20 ,20 ,20 ,20 ,20),
    ...
    .species = SPECIES_EXEGGCUTE,
    .ability = ABILITY_HARVEST,
    .moves = {MOVE_MEGA_DRAIN, MOVE_LEECH_SEED, MOVE_SLEEP_POWDER, MOVE_PSYBEAM}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .moves = {MOVE_MEGA_DRAIN, MOVE_POISON_POWDER, MOVE_CONSTRICT, MOVE_KNOCK_OFF}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
...
static const struct TrainerMon sParty_DrakeGym4[] = {
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    .iv = TRAINER_PARTY_IVS(20, 20 ,20 ,20 ,20 ,20),
    ...
    .moves = {MOVE_DRAGON_TAIL, MOVE_ROCK_SLIDE, MOVE_BITE, MOVE_STEALTH_ROCK}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .ability = ABILITY_HYPER_CUTTER,
    .moves = {MOVE_DRAGON_BREATH, MOVE_EARTH_POWER, MOVE_BUG_BUZZ, MOVE_ROCK_SLIDE}
    },
};

static const struct TrainerMon sParty_GiovanniGym4[] = {
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    .iv = TRAINER_PARTY_IVS(20, 20 ,20 ,20 ,20 ,20),
    ...
    .species = SPECIES_RHYHORN,
    .ability = ABILITY_ROCK_HEAD,
    .moves = {MOVE_ROCK_TOMB, MOVE_BULLDOZE, MOVE_TAIL_WHIP, MOVE_CHIP_AWAY}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .moves = {MOVE_BULLDOZE, MOVE_SUCKER_PUNCH, MOVE_TRI_ATTACK, MOVE_ROCK_TOMB}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
...
static const struct TrainerMon sParty_KogaGym4[] = {
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    .iv = TRAINER_PARTY_IVS(20, 20 ,20 ,20 ,20 ,20),
    ...
    .species = SPECIES_KOFFING,
    .ability = ABILITY_LEVITATE,
    .moves = {MOVE_SLUDGE, MOVE_SELF_DESTRUCT, MOVE_TOXIC, MOVE_ASSURANCE}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_GRIMER,
    .ability = ABILITY_POISON_TOUCH,
    .moves = {MOVE_SLUDGE, MOVE_MUD_BOMB, MOVE_MINIMIZE, MOVE_TOXIC}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .moves = {MOVE_SILVER_WIND, MOVE_LIGHT_SCREEN, MOVE_PSYBEAM, MOVE_VENOSHOCK}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
...
static const struct TrainerMon sParty_StevenGym4[] = {
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    .iv = TRAINER_PARTY_IVS(20, 20 ,20 ,20 ,20 ,20),
    ...
    .species = SPECIES_ARON,
    .ability = ABILITY_STURDY,
    .moves = {MOVE_ROCK_TOMB, MOVE_IRON_HEAD, MOVE_TAKE_DOWN, MOVE_MUD_SLAP}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_FERROSEED,
    .ability = ABILITY_IRON_BARBS,
    .moves = {MOVE_METAL_CLAW, MOVE_CURSE, MOVE_LEECH_SEED, MOVE_BULLET_SEED}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .ability = ABILITY_FILTER,
    .moves = {MOVE_MIRROR_SHOT, MOVE_BUG_BITE, MOVE_CONFUSION, MOVE_QUIVER_DANCE}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
...
static const struct TrainerMon sParty_BugsyGym4[] = {
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    .iv = TRAINER_PARTY_IVS(20, 20 ,20 ,20 ,20 ,20),
    ...
    .ability = ABILITY_WATER_BUBBLE,
    .moves = {MOVE_BUBBLE_BEAM, MOVE_INFESTATION, MOVE_BUG_BITE, MOVE_CRUNCH}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .ability = ABILITY_TINTED_LENS,
    .moves = {MOVE_POUNCE, MOVE_PSYBEAM, MOVE_STUN_SPORE, MOVE_SIGNAL_BEAM}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .ability = ABILITY_EFFECT_SPORE,
    .moves = {MOVE_GIGA_DRAIN, MOVE_SPORE, MOVE_BUG_BITE, MOVE_SLASH}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_SCYTHER,
    .ability = ABILITY_SWARM,
    .moves = {MOVE_FURY_CUTTER, MOVE_WING_ATTACK, MOVE_FOCUS_ENERGY, MOVE_SLASH}
    }
};

static const struct TrainerMon sParty_ValerieGym4[] = {
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    .iv = TRAINER_PARTY_IVS(20, 20 ,20 ,20 ,20 ,20),
    ...
    .species = SPECIES_CLEFAIRY,
    .ability = ABILITY_CUTE_CHARM,
    .moves = {MOVE_DRAINING_KISS, MOVE_METRONOME, MOVE_MINIMIZE, MOVE_WAKE_UP_SLAP}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_MR_MIME,
    .ability = ABILITY_FILTER,
    .moves = {MOVE_PSYBEAM, MOVE_FAKE_OUT, MOVE_ICY_WIND, MOVE_REFLECT}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_MAWILE,
    .ability = ABILITY_INTIMIDATE,
    .moves = {MOVE_CRUNCH, MOVE_IRON_HEAD, MOVE_VICE_GRIP, MOVE_CAPTIVATE}
    }
};

// Gym 5

static const struct TrainerMon sParty_RoxanneGym5[] = {
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    .iv = TRAINER_PARTY_IVS(20, 20 ,20 ,20 ,20 ,20),
    ...
    .species = SPECIES_LILEEP,
    .ability = ABILITY_STORM_DRAIN,
    .moves = {MOVE_BRINE, MOVE_ANCIENT_POWER, MOVE_GIGA_DRAIN, MOVE_SANDSTORM}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_RELICANTH,
    .ability = ABILITY_STURDY,
    .moves = {MOVE_ROCK_TOMB, MOVE_YAWN, MOVE_DIVE, MOVE_AMNESIA}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .ability = ABILITY_STURDY,
    .moves = {MOVE_TRI_ATTACK, MOVE_ROCK_SLIDE, MOVE_IRON_DEFENSE, MOVE_DISCHARGE}
    }
};

static const struct TrainerMon sParty_NormanGym5[] = {
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    .iv = TRAINER_PARTY_IVS(20, 20 ,20 ,20 ,20 ,20),
    ...
    .species = SPECIES_LOUDRED,
    .ability = ABILITY_SOUNDPROOF,
    .moves = {MOVE_STOMP, MOVE_WATER_PULSE, MOVE_BITE, MOVE_SUPERSONIC}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_VIGOROTH,
    .ability = ABILITY_VITAL_SPIRIT,
    .moves = {MOVE_SLASH, MOVE_SLACK_OFF, MOVE_YAWN, MOVE_FEINT_ATTACK}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_BIBAREL,
    .ability = ABILITY_UNAWARE,
    .moves = {MOVE_HEADBUTT, MOVE_WATER_PULSE, MOVE_ROLLOUT, MOVE_YAWN}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_LINOONE,
    .ability = ABILITY_QUICK_FEET,
    .moves = {MOVE_HEADBUTT, MOVE_CHARM, MOVE_PIN_MISSILE, MOVE_SHADOW_CLAW}
    }
};

static const struct TrainerMon sParty_BrawlyGym5[] = {
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    .iv = TRAINER_PARTY_IVS(20, 20 ,20 ,20 ,20 ,20),
    ...
    .species = SPECIES_BRELOOM,
    .ability = ABILITY_TECHNICIAN,
    .moves = {MOVE_BULLET_SEED, MOVE_LEECH_SEED, MOVE_HEADBUTT, MOVE_MACH_PUNCH}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_MEDITITE,
    .ability = ABILITY_PURE_POWER,
    .moves = {MOVE_PSYBEAM, MOVE_BULK_UP, MOVE_HIGH_JUMP_KICK, MOVE_BULLET_PUNCH}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_HARIYAMA,
    .ability = ABILITY_GUTS,
    .moves = {MOVE_LOW_KICK, MOVE_BULK_UP, MOVE_DIG, MOVE_KNOCK_OFF}
    }
};

static const struct TrainerMon sParty_WattsonGym5[] = {
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    .iv = TRAINER_PARTY_IVS(20, 20 ,20 ,20 ,20 ,20),
    ...
    .species = SPECIES_MAGNETON,
    .ability = ABILITY_STURDY,
    .moves = {MOVE_SHOCK_WAVE, MOVE_FLASH_CANNON, MOVE_THUNDER_WAVE, MOVE_SONIC_BOOM}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_VOLTORB_HISUIAN,
    .ability = ABILITY_STATIC,
    .moves = {MOVE_ELECTRO_BALL, MOVE_DISCHARGE, MOVE_SWIFT, MOVE_SEED_BOMB}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_PINCURCHIN,
    .ability = ABILITY_ELECTRIC_SURGE,
    .moves = {MOVE_BUBBLE_BEAM, MOVE_SPARK, MOVE_RECOVER, MOVE_PIN_MISSILE}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
...
static const struct TrainerMon sParty_FlanneryGym5[] = {
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    .iv = TRAINER_PARTY_IVS(20, 20 ,20 ,20 ,20 ,20),
    ...
    .species = SPECIES_MAGCARGO,
    .ability = ABILITY_MAGMA_ARMOR,
    .moves = {MOVE_FLAME_BURST, MOVE_ANCIENT_POWER, MOVE_YAWN, MOVE_CLEAR_SMOG}
    }
};

static const struct TrainerMon sParty_WinonaGym5[] = {
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    .iv = TRAINER_PARTY_IVS(20, 20 ,20 ,20 ,20 ,20),
    ...
    .species = SPECIES_STARAVIA,
    .ability = ABILITY_INTIMIDATE,
    .moves = {MOVE_AERIAL_ACE, MOVE_DOUBLE_TEAM, MOVE_QUICK_ATTACK, MOVE_ROOST}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_PELIPPER,
    .ability = ABILITY_KEEN_EYE,
    .moves = {MOVE_WATER_PULSE, MOVE_AIR_CUTTER, MOVE_TAILWIND, MOVE_PAYBACK}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
...
static const struct TrainerMon sParty_TateGym5[] = {
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    .iv = TRAINER_PARTY_IVS(20, 20 ,20 ,20 ,20 ,20),
    ...
    .species = SPECIES_SOLROCK,
    .ability = ABILITY_LEVITATE,
    .moves = {MOVE_PSYCHIC, MOVE_FLAMETHROWER, MOVE_ROCK_SLIDE, MOVE_COSMIC_POWER}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
...
static const struct TrainerMon sParty_JuanGym5[] = {
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    .iv = TRAINER_PARTY_IVS(20, 20 ,20 ,20 ,20 ,20),
    ...
    .moves = {MOVE_WATER_PULSE, MOVE_CONFUSE_RAY, MOVE_ICE_FANG, MOVE_SUCKER_PUNCH}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_CRAWDAUNT,
    .ability = ABILITY_ADAPTABILITY,
    .moves = {MOVE_AQUA_JET, MOVE_BUBBLE_BEAM, MOVE_DOUBLE_HIT, MOVE_NIGHT_SLASH}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_LOMBRE,
    .ability = ABILITY_OWN_TEMPO,
    .moves = {MOVE_BUBBLE_BEAM, MOVE_FAKE_OUT, MOVE_ICE_PUNCH, MOVE_GIGA_DRAIN}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_WHISCASH,
    .ability = ABILITY_HYDRATION,
    .moves = {MOVE_MUDDY_WATER, MOVE_MUD_BOMB, MOVE_AQUA_TAIL, MOVE_BELCH}
    },
};

static const struct TrainerMon sParty_SidneyGym5[] = {
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    .iv = TRAINER_PARTY_IVS(20, 20 ,20 ,20 ,20 ,20),
    ...
    .species = SPECIES_NUZLEAF,
    .ability = ABILITY_CHLOROPHYLL,
    .moves = {MOVE_FEINT_ATTACK, MOVE_EXTRASENSORY, MOVE_LEAF_BLADE, MOVE_NATURE_POWER}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_SHARPEDO,
    .ability = ABILITY_ROUGH_SKIN,
    .moves = {MOVE_BITE, MOVE_ICE_FANG, MOVE_POISON_FANG, MOVE_FLIP_TURN}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_MIGHTYENA,
    .ability = ABILITY_INTIMIDATE,
    .moves = {MOVE_BITE, MOVE_SWAGGER, MOVE_HEADBUTT, MOVE_FIRE_FANG}
    }
};

static const struct TrainerMon sParty_PhoebeGym5[] = {
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    .iv = TRAINER_PARTY_IVS(20, 20 ,20 ,20 ,20 ,20),
    ...
    .species = SPECIES_DUSKULL,
    .ability = ABILITY_LEVITATE,
    .moves = {MOVE_NIGHT_SHADE, MOVE_CURSE, MOVE_WILL_O_WISP, MOVE_PAYBACK}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_BANETTE,
    .ability = ABILITY_CURSED_BODY,
    .moves = {MOVE_HEX, MOVE_SHADOW_SNEAK, MOVE_CURSE, MOVE_KNOCK_OFF}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_SABLEYE,
    .ability = ABILITY_MAGIC_BOUNCE,
    .moves = {MOVE_SHADOW_CLAW, MOVE_FAKE_OUT, MOVE_FURY_SWIPES, MOVE_KNOCK_OFF}
    }
};

static const struct TrainerMon sParty_GlaciaGym5[] = {
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    .iv = TRAINER_PARTY_IVS(20, 20 ,20 ,20 ,20 ,20),
    ...
    .ability = ABILITY_HYPER_CUTTER,
    .moves = {MOVE_POWER_UP_PUNCH, MOVE_AVALANCHE, MOVE_BRICK_BREAK, MOVE_DIZZY_PUNCH}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_MR_MIME_GALARIAN,
    .ability = ABILITY_VITAL_SPIRIT,
    .moves = {MOVE_ICY_WIND, MOVE_SNOWSCAPE, MOVE_PSYBEAM, MOVE_DOUBLE_KICK}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_SEALEO,
    .ability = ABILITY_THICK_FAT,
    .moves = {MOVE_AURORA_BEAM, MOVE_BRINE, MOVE_REST, MOVE_YAWN}
    },
};

static const struct TrainerMon sParty_ErikaGym5[] = {
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    .iv = TRAINER_PARTY_IVS(20, 20 ,20 ,20 ,20 ,20),
    ...
    .species = SPECIES_WEEPINBELL,
    .ability = ABILITY_CHLOROPHYLL,
    .moves = {MOVE_BULLET_SEED, MOVE_LEECH_LIFE, MOVE_SLEEP_POWDER, MOVE_VENOSHOCK}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .ability = ABILITY_HARVEST,
    .moves = {MOVE_GIGA_DRAIN, MOVE_SYNTHESIS, MOVE_SLEEP_POWDER, MOVE_PSYBEAM}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_TANGELA,
    .ability = ABILITY_LEAF_GUARD,
    .moves = {MOVE_GIGA_DRAIN, MOVE_POISON_POWDER, MOVE_CONSTRICT, MOVE_KNOCK_OFF}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_VILEPLUME,
    .ability = ABILITY_CHLOROPHYLL,
    .moves = {MOVE_GIGA_DRAIN, MOVE_GROWTH, MOVE_VENOSHOCK, MOVE_MOONLIGHT}
    }
};

static const struct TrainerMon sParty_DrakeGym5[] = {
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    .iv = TRAINER_PARTY_IVS(20, 20 ,20 ,20 ,20 ,20),
    ...
    .species = SPECIES_TYRUNT,
    .ability = ABILITY_STRONG_JAW,
    .moves = {MOVE_DRAGON_TAIL, MOVE_ROCK_SLIDE, MOVE_CRUNCH, MOVE_STEALTH_ROCK}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_SKRELP,
    .ability = ABILITY_POISON_POINT,
    .moves = {MOVE_WATER_PULSE, MOVE_POISON_TAIL, MOVE_FEINT_ATTACK, MOVE_TOXIC}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_SHELGON,
    .ability = ABILITY_ROCK_HEAD,
    .moves = {MOVE_DRAGON_CLAW, MOVE_FIRE_FANG, MOVE_CRUNCH, MOVE_HEADBUTT}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
...
static const struct TrainerMon sParty_GiovanniGym5[] = {
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    .iv = TRAINER_PARTY_IVS(20, 20 ,20 ,20 ,20 ,20),
    ...
    .species = SPECIES_RHYHORN,
    .ability = ABILITY_ROCK_HEAD,
    .moves = {MOVE_ROCK_TOMB, MOVE_DRILL_RUN, MOVE_TAIL_WHIP, MOVE_CHIP_AWAY}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_DUGTRIO,
    .ability = ABILITY_SAND_VEIL,
    .moves = {MOVE_BULLDOZE, MOVE_SUCKER_PUNCH, MOVE_AERIAL_ACE, MOVE_ROCK_TOMB}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_NIDORINO,
    .ability = ABILITY_POISON_POINT,
    .moves = {MOVE_POISON_TAIL, MOVE_STOMPING_TANTRUM, MOVE_DOUBLE_KICK, MOVE_SMART_STRIKE}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_MAROWAK,
    .ability = ABILITY_BATTLE_ARMOR,
    .moves = {MOVE_BONEMERANG, MOVE_BRUTAL_SWING, MOVE_DOUBLE_KICK, MOVE_ROCK_TOMB}
    },
};

static const struct TrainerMon sParty_KogaGym5[] = {
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    .iv = TRAINER_PARTY_IVS(20, 20 ,20 ,20 ,20 ,20),
    ...
    .species = SPECIES_GRIMER,
    .ability = ABILITY_POISON_TOUCH,
    .moves = {MOVE_SLUDGE_BOMB, MOVE_MUD_BOMB, MOVE_MINIMIZE, MOVE_TOXIC}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_DUSTOX,
    .ability = ABILITY_COMPOUND_EYES,
    .moves = {MOVE_SILVER_WIND, MOVE_MOONLIGHT, MOVE_PSYBEAM, MOVE_VENOSHOCK}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_CROBAT,
    .ability = ABILITY_INNER_FOCUS,
    .moves = {MOVE_CROSS_POISON, MOVE_WING_ATTACK, MOVE_BITE, MOVE_CONFUSE_RAY}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_WEEZING,
    .ability = ABILITY_LEVITATE,
    .moves = {MOVE_SLUDGE, MOVE_DOUBLE_HIT, MOVE_TOXIC, MOVE_ASSURANCE}
    }
};

static const struct TrainerMon sParty_StevenGym5[] = {
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    .iv = TRAINER_PARTY_IVS(20, 20 ,20 ,20 ,20 ,20),
    ...
    .species = SPECIES_FERROSEED,
    .ability = ABILITY_IRON_BARBS,
    .moves = {MOVE_IRON_HEAD, MOVE_CURSE, MOVE_LEECH_SEED, MOVE_BULLET_SEED}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_WORMADAM,
    .ability = ABILITY_FILTER,
    .moves = {MOVE_MIRROR_SHOT, MOVE_BUG_BITE, MOVE_PSYBEAM, MOVE_QUIVER_DANCE}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_METANG,
    .ability = ABILITY_CLEAR_BODY,
    .moves = {MOVE_TAKE_DOWN, MOVE_FLASH_CANNON, MOVE_PSYCHIC, MOVE_METAL_CLAW}
    }
};

static const struct TrainerMon sParty_BugsyGym5[] = {
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    .iv = TRAINER_PARTY_IVS(20, 20 ,20 ,20 ,20 ,20),
    ...
    .species = SPECIES_ARAQUANID,
    .ability = ABILITY_WATER_BUBBLE,
    .moves = {MOVE_SCALD, MOVE_INFESTATION, MOVE_BUG_BITE, MOVE_CRUNCH}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_VENOMOTH,
    .ability = ABILITY_TINTED_LENS,
    .moves = {MOVE_VENOSHOCK, MOVE_PSYBEAM, MOVE_STUN_SPORE, MOVE_SIGNAL_BEAM}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_SCYTHER,
    .ability = ABILITY_SWARM,
    .moves = {MOVE_U_TURN, MOVE_WING_ATTACK, MOVE_FOCUS_ENERGY, MOVE_SLASH}
    }
};

static const struct TrainerMon sParty_ValerieGym5[] = {
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    .iv = TRAINER_PARTY_IVS(20, 20 ,20 ,20 ,20 ,20),
    ...
    .species = SPECIES_CLEFAIRY,
    .ability = ABILITY_CUTE_CHARM,
    .moves = {MOVE_DAZZLING_GLEAM, MOVE_METEOR_MASH, MOVE_MINIMIZE, MOVE_WAKE_UP_SLAP}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_MR_MIME,
    .ability = ABILITY_FILTER,
    .moves = {MOVE_PSYBEAM, MOVE_LIGHT_SCREEN, MOVE_ICY_WIND, MOVE_REFLECT}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_SHIINOTIC,
    .ability = ABILITY_EFFECT_SPORE,
    .moves = {MOVE_GIGA_DRAIN, MOVE_SLEEP_POWDER, MOVE_GROWTH, MOVE_DRAINING_KISS}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_MAWILE,
    .ability = ABILITY_INTIMIDATE,
    .moves = {MOVE_CRUNCH, MOVE_IRON_HEAD, MOVE_DRAINING_KISS, MOVE_CAPTIVATE}
    }
};

// Gym 6

static const struct TrainerMon sParty_RoxanneGym6[] = {
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_ARMALDO,
    .ability = ABILITY_BATTLE_ARMOR,
    .moves = {MOVE_X_SCISSOR, MOVE_ROCK_SLIDE, MOVE_ANCIENT_POWER, MOVE_METAL_CLAW}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_RELICANTH,
    .ability = ABILITY_STURDY,
    .moves = {MOVE_ROCK_SLIDE, MOVE_YAWN, MOVE_DIVE, MOVE_AMNESIA}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_PROBOPASS,
    .ability = ABILITY_STURDY,
    .moves = {MOVE_TRI_ATTACK, MOVE_POWER_GEM, MOVE_IRON_DEFENSE, MOVE_DISCHARGE}
    }
};

static const struct TrainerMon sParty_NormanGym6[] = {
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    .iv = TRAINER_PARTY_IVS(23, 23 ,23 ,23 ,23 ,23),
    ...
    .species = SPECIES_EXPLOUD,
    .ability = ABILITY_SOUNDPROOF,
    .moves = {MOVE_HYPER_VOICE, MOVE_WATER_PULSE, MOVE_CRUNCH, MOVE_SUPERSONIC}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_BIBAREL,
    .ability = ABILITY_UNAWARE,
    .moves = {MOVE_HEADBUTT, MOVE_WATER_PULSE, MOVE_ROLLOUT, MOVE_SUPER_FANG}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_LINOONE,
    .ability = ABILITY_QUICK_FEET,
    .moves = {MOVE_HEADBUTT, MOVE_BELLY_DRUM, MOVE_PIN_MISSILE, MOVE_SHADOW_CLAW}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
...
static const struct TrainerMon sParty_BrawlyGym6[] = {
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    .iv = TRAINER_PARTY_IVS(23, 23 ,23 ,23 ,23 ,23),
    ...
    .species = SPECIES_BRELOOM,
    .ability = ABILITY_TECHNICIAN,
    .moves = {MOVE_BULLET_SEED, MOVE_LEECH_SEED, MOVE_FORCE_PALM, MOVE_MACH_PUNCH}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_MEDICHAM,
    .ability = ABILITY_PURE_POWER,
    .moves = {MOVE_ZEN_HEADBUTT, MOVE_BULK_UP, MOVE_HIGH_JUMP_KICK, MOVE_BULLET_PUNCH}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_HITMONTOP,
    .ability = ABILITY_INTIMIDATE,
    .moves = {MOVE_RAPID_SPIN, MOVE_COUNTER, MOVE_TRIPLE_KICK, MOVE_FOCUS_ENERGY}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_HARIYAMA,
    .ability = ABILITY_GUTS,
    .moves = {MOVE_DRAIN_PUNCH, MOVE_BULK_UP, MOVE_DIG, MOVE_KNOCK_OFF}
    }
};

static const struct TrainerMon sParty_WattsonGym6[] = {
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    .iv = TRAINER_PARTY_IVS(23, 23 ,23 ,23 ,23 ,23),
    ...
    .moves = {MOVE_VOLT_SWITCH, MOVE_DISCHARGE, MOVE_SWIFT, MOVE_SEED_BOMB}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_PINCURCHIN,
    .ability = ABILITY_ELECTRIC_SURGE,
    .moves = {MOVE_BUBBLE_BEAM, MOVE_SPARK, MOVE_RECOVER, MOVE_POISON_JAB}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_MANECTRIC,
    .ability = ABILITY_STATIC,
    .moves = {MOVE_THUNDER_WAVE, MOVE_QUICK_ATTACK, MOVE_BITE, MOVE_DISCHARGE}
    }
};

static const struct TrainerMon sParty_FlanneryGym6[] = {
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    .iv = TRAINER_PARTY_IVS(23, 23 ,23 ,23 ,23 ,23),
    ...
    .species = SPECIES_CAMERUPT,
    .ability = ABILITY_OWN_TEMPO,
    .moves = {MOVE_LAVA_PLUME, MOVE_EARTH_POWER, MOVE_CURSE, MOVE_SUNNY_DAY}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .ability = ABILITY_BLAZE,
    .moves = {MOVE_DOUBLE_KICK, MOVE_BLAZE_KICK, MOVE_AERIAL_ACE, MOVE_BULK_UP}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_MAGCARGO,
    .ability = ABILITY_MAGMA_ARMOR,
    .moves = {MOVE_FLAME_BURST, MOVE_ANCIENT_POWER, MOVE_YAWN, MOVE_SUNNY_DAY}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
...
static const struct TrainerMon sParty_WinonaGym6[] = {
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    .iv = TRAINER_PARTY_IVS(23, 23 ,23 ,23 ,23 ,23),
    ...
    .species = SPECIES_PELIPPER,
    .ability = ABILITY_KEEN_EYE,
    .moves = {MOVE_WATER_PULSE, MOVE_AIR_SLASH, MOVE_TAILWIND, MOVE_PAYBACK}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_TROPIUS,
    .ability = ABILITY_CHLOROPHYLL,
    .moves = {MOVE_SOLAR_BEAM, MOVE_BODY_SLAM, MOVE_SUNNY_DAY, MOVE_AIR_SLASH}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_SWELLOW,
    .ability = ABILITY_SCRAPPY,
    .moves = {MOVE_AERIAL_ACE, MOVE_FACADE, MOVE_STEEL_WING, MOVE_DOUBLE_TEAM}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_ALTARIA,
    .ability = ABILITY_NATURAL_CURE,
    .moves = {MOVE_PLUCK, MOVE_MOONBLAST, MOVE_SING, MOVE_DRAGON_PULSE}
    }
};

static const struct TrainerMon sParty_TateGym6[] = {
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    .iv = TRAINER_PARTY_IVS(23, 23 ,23 ,23 ,23 ,23),
    ...
    .ability = ABILITY_STEADFAST,
    .moves = {MOVE_PSYCHO_CUT, MOVE_AERIAL_ACE, MOVE_BRICK_BREAK, MOVE_FURY_CUTTER}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_SOLROCK,
    .ability = ABILITY_LEVITATE,
    .moves = {MOVE_ZEN_HEADBUTT, MOVE_FLAMETHROWER, MOVE_ROCK_SLIDE, MOVE_COSMIC_POWER}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_MALAMAR,
    .ability = ABILITY_CONTRARY,
    .moves = {MOVE_PSYCHO_CUT, MOVE_PLUCK, MOVE_LASH_OUT, MOVE_SWAGGER}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_CLAYDOL,
    .ability = ABILITY_LEVITATE,
    .moves = {MOVE_EXTRASENSORY, MOVE_RAPID_SPIN, MOVE_SIGNAL_BEAM, MOVE_EARTH_POWER}
    }
};

static const struct TrainerMon sParty_JuanGym6[] = {
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    .iv = TRAINER_PARTY_IVS(23, 23 ,23 ,23 ,23 ,23),
    ...
    .species = SPECIES_HUNTAIL,
    .ability = ABILITY_WATER_VEIL,
    .moves = {MOVE_AQUA_TAIL, MOVE_CONFUSE_RAY, MOVE_ICE_FANG, MOVE_SUCKER_PUNCH}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_CRAWDAUNT,
    .ability = ABILITY_ADAPTABILITY,
    .moves = {MOVE_AQUA_JET, MOVE_BUBBLE_BEAM, MOVE_SWORDS_DANCE, MOVE_NIGHT_SLASH}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_WHISCASH,
    .ability = ABILITY_HYDRATION,
    .moves = {MOVE_MUDDY_WATER, MOVE_MUD_BOMB, MOVE_AQUA_TAIL, MOVE_ZEN_HEADBUTT}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_LUDICOLO,
    .ability = ABILITY_OWN_TEMPO,
    .moves = {MOVE_SURF, MOVE_FAKE_OUT, MOVE_ICE_PUNCH, MOVE_GIGA_DRAIN}
    }
};

static const struct TrainerMon sParty_SidneyGym6[] = {
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    .iv = TRAINER_PARTY_IVS(23, 23 ,23 ,23 ,23 ,23),
    ...
    .species = SPECIES_SHARPEDO,
    .ability = ABILITY_ROUGH_SKIN,
    .moves = {MOVE_CRUNCH, MOVE_ICE_FANG, MOVE_POISON_FANG, MOVE_FLIP_TURN}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_MIGHTYENA,
    .ability = ABILITY_INTIMIDATE,
    .moves = {MOVE_CRUNCH, MOVE_SWAGGER, MOVE_HEADBUTT, MOVE_FIRE_FANG}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
...
static const struct TrainerMon sParty_PhoebeGym6[] = {
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    .iv = TRAINER_PARTY_IVS(23, 23 ,23 ,23 ,23 ,23),
    ...
    .ability = ABILITY_HARVEST,
    .moves = {MOVE_SHADOW_CLAW, MOVE_WILL_O_WISP, MOVE_HORN_LEECH, MOVE_LEECH_SEED}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .moves = {MOVE_NIGHT_SHADE, MOVE_SHADOW_PUNCH, MOVE_WILL_O_WISP, MOVE_PAYBACK}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_SABLEYE,
    .ability = ABILITY_MAGIC_BOUNCE,
    .moves = {MOVE_SHADOW_CLAW, MOVE_FAKE_OUT, MOVE_NIGHT_SHADE, MOVE_KNOCK_OFF}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_BANETTE,
    .ability = ABILITY_CURSED_BODY,
    .moves = {MOVE_SHADOW_BALL, MOVE_SHADOW_SNEAK, MOVE_CURSE, MOVE_KNOCK_OFF}
    }
};

static const struct TrainerMon sParty_GlaciaGym6[] = {
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    .iv = TRAINER_PARTY_IVS(23, 23 ,23 ,23 ,23 ,23),
    ...
    .species = SPECIES_CRABOMINABLE,
    .ability = ABILITY_HYPER_CUTTER,
    .moves = {MOVE_POWER_UP_PUNCH, MOVE_ICE_PUNCH, MOVE_BRICK_BREAK, MOVE_DIZZY_PUNCH}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .moves = {MOVE_FREEZE_DRY, MOVE_WATER_PULSE, MOVE_BITE, MOVE_HEADBUTT}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .moves = {MOVE_FREEZE_DRY, MOVE_SNOWSCAPE, MOVE_PSYBEAM, MOVE_DOUBLE_KICK}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_WALREIN,
    .ability = ABILITY_THICK_FAT,
    .moves = {MOVE_AURORA_BEAM, MOVE_BRINE, MOVE_REST, MOVE_BODY_SLAM}
    },
};

static const struct TrainerMon sParty_ErikaGym6[] = {
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    .iv = TRAINER_PARTY_IVS(23, 23 ,23 ,23 ,23 ,23),
    ...
    .species = SPECIES_EXEGGUTOR,
    .ability = ABILITY_CHLOROPHYLL,
    .moves = {MOVE_GIGA_DRAIN, MOVE_SYNTHESIS, MOVE_SUNNY_DAY, MOVE_PSYBEAM}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .ability = ABILITY_LEAF_GUARD,
    .moves = {MOVE_GIGA_DRAIN, MOVE_ANCIENT_POWER, MOVE_SLAM, MOVE_KNOCK_OFF}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
...
static const struct TrainerMon sParty_DrakeGym6[] = {
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    .iv = TRAINER_PARTY_IVS(23, 23 ,23 ,23 ,23 ,23),
    ...
    .ability = ABILITY_STRONG_JAW,
    .moves = {MOVE_DRAGON_TAIL, MOVE_ROCK_SLIDE, MOVE_CRUNCH, MOVE_ZEN_HEADBUTT}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_SKRELP,
    .ability = ABILITY_POISON_POINT,
    .moves = {MOVE_WATER_PULSE, MOVE_VENOSHOCK, MOVE_FEINT_ATTACK, MOVE_TOXIC}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_FLYGON,
    .ability = ABILITY_LEVITATE,
    .moves = {MOVE_DRAGON_CLAW, MOVE_EARTH_POWER, MOVE_BUG_BUZZ, MOVE_ROCK_SLIDE}
    },
};

static const struct TrainerMon sParty_GiovanniGym6[] = {
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    .iv = TRAINER_PARTY_IVS(23, 23 ,23 ,23 ,23 ,23),
    ...
    .species = SPECIES_RHYDON,
    .ability = ABILITY_ROCK_HEAD,
    .moves = {MOVE_ROCK_TOMB, MOVE_DRILL_RUN, MOVE_FIRE_FANG, MOVE_TAKE_DOWN}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_DUGTRIO,
    .ability = ABILITY_SAND_VEIL,
    .moves = {MOVE_BULLDOZE, MOVE_SUCKER_PUNCH, MOVE_AERIAL_ACE, MOVE_ROCK_SLIDE}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
...
static const struct TrainerMon sParty_KogaGym6[] = {
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    .iv = TRAINER_PARTY_IVS(23, 23 ,23 ,23 ,23 ,23),
    ...
    .species = SPECIES_WEEZING,
    .ability = ABILITY_LEVITATE,
    .moves = {MOVE_SLUDGE_BOMB, MOVE_DOUBLE_HIT, MOVE_TOXIC, MOVE_ASSURANCE}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_DUSTOX,
    .ability = ABILITY_COMPOUND_EYES,
    .moves = {MOVE_BUG_BUZZ, MOVE_MOONLIGHT, MOVE_PSYBEAM, MOVE_VENOSHOCK}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_CROBAT,
    .ability = ABILITY_INNER_FOCUS,
    .moves = {MOVE_CROSS_POISON, MOVE_WING_ATTACK, MOVE_LEECH_LIFE, MOVE_CONFUSE_RAY}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_MUK,
    .ability = ABILITY_POISON_TOUCH,
    .moves = {MOVE_SLUDGE_BOMB, MOVE_MUD_BOMB, MOVE_MINIMIZE, MOVE_THUNDERPUNCH}
    },
};

static const struct TrainerMon sParty_StevenGym6[] = {
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    .iv = TRAINER_PARTY_IVS(23, 23 ,23 ,23 ,23 ,23),
    ...
    .species = SPECIES_AGGRON,
    .ability = ABILITY_STURDY,
    .moves = {MOVE_ROCK_TOMB, MOVE_IRON_HEAD, MOVE_TAKE_DOWN, MOVE_AUTOTOMIZE}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .ability = ABILITY_IRON_BARBS,
    .moves = {MOVE_IRON_HEAD, MOVE_CURSE, MOVE_LEECH_SEED, MOVE_POWER_WHIP}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_WORMADAM,
    .ability = ABILITY_FILTER,
    .moves = {MOVE_MIRROR_SHOT, MOVE_BUG_BITE, MOVE_PSYCHIC, MOVE_QUIVER_DANCE}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_METANG,
    .ability = ABILITY_CLEAR_BODY,
    .moves = {MOVE_TAKE_DOWN, MOVE_HAMMER_ARM, MOVE_PSYCHIC, MOVE_METAL_CLAW}
    }
};

static const struct TrainerMon sParty_BugsyGym6[] = {
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    .iv = TRAINER_PARTY_IVS(23, 23 ,23 ,23 ,23 ,23),
    ...
    .species = SPECIES_ARAQUANID,
    .ability = ABILITY_WATER_BUBBLE,
    .moves = {MOVE_LIQUIDATION, MOVE_INFESTATION, MOVE_BUG_BITE, MOVE_CRUNCH}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_VENOMOTH,
    .ability = ABILITY_TINTED_LENS,
    .moves = {MOVE_SLUDGE_BOMB, MOVE_PSYBEAM, MOVE_STUN_SPORE, MOVE_SIGNAL_BEAM}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_PARASECT,
    .ability = ABILITY_EFFECT_SPORE,
    .moves = {MOVE_GIGA_DRAIN, MOVE_SPORE, MOVE_BUG_BITE, MOVE_DIG}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
...
static const struct TrainerMon sParty_ValerieGym6[] = {
        {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    .iv = TRAINER_PARTY_IVS(23, 23 ,23 ,23 ,23 ,23),
    ...
    .species = SPECIES_MR_MIME,
    .ability = ABILITY_FILTER,
    .moves = {MOVE_PSYBEAM, MOVE_LIGHT_SCREEN, MOVE_DAZZLING_GLEAM, MOVE_REFLECT}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_SHIINOTIC,
    .ability = ABILITY_EFFECT_SPORE,
    .moves = {MOVE_GIGA_DRAIN, MOVE_STRENGTH_SAP, MOVE_GROWTH, MOVE_DRAINING_KISS}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_MAWILE,
    .ability = ABILITY_INTIMIDATE,
    .moves = {MOVE_CRUNCH, MOVE_IRON_HEAD, MOVE_DRAINING_KISS, MOVE_SWORDS_DANCE}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .moves = {MOVE_SWIFT, MOVE_LIGHT_SCREEN, MOVE_SHADOW_BALL, MOVE_DRAINING_KISS}
    },
};

// Gym 7

static const struct TrainerMon sParty_RoxanneGym7[] = {
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    .iv = TRAINER_PARTY_IVS(27, 27 ,27 ,27 ,27 ,27),
    ...
    .species = SPECIES_ARMALDO,
    .ability = ABILITY_BATTLE_ARMOR,
    .moves = {MOVE_X_SCISSOR, MOVE_ROCK_SLIDE, MOVE_STEALTH_ROCK, MOVE_METAL_CLAW}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_CRADILY,
    .ability = ABILITY_STORM_DRAIN,
    .moves = {MOVE_BRINE, MOVE_ROCK_SLIDE, MOVE_GIGA_DRAIN, MOVE_SANDSTORM}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_RELICANTH,
    .ability = ABILITY_STURDY,
    .moves = {MOVE_ROCK_SLIDE, MOVE_YAWN, MOVE_DIVE, MOVE_BULLDOZE}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_PROBOPASS,
    .ability = ABILITY_STURDY,
    .moves = {MOVE_TRI_ATTACK, MOVE_POWER_GEM, MOVE_FLASH_CANNON, MOVE_DISCHARGE}
    }
};

static const struct TrainerMon sParty_NormanGym7[] = {
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    .iv = TRAINER_PARTY_IVS(27, 27 ,27 ,27 ,27 ,27),
    ...
    .species = SPECIES_EXPLOUD,
    .ability = ABILITY_SOUNDPROOF,
    .moves = {MOVE_HYPER_VOICE, MOVE_WATER_PULSE, MOVE_CRUNCH, MOVE_REST}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_BIBAREL,
    .ability = ABILITY_UNAWARE,
    .moves = {MOVE_HEADBUTT, MOVE_SCALD, MOVE_ROLLOUT, MOVE_SUPER_FANG}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_LINOONE,
    .ability = ABILITY_QUICK_FEET,
    .moves = {MOVE_DOUBLE_EDGE, MOVE_BELLY_DRUM, MOVE_PIN_MISSILE, MOVE_SHADOW_CLAW}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_SLAKING,
    .ability = ABILITY_VITAL_SPIRIT,
    .moves = {MOVE_TAKE_DOWN, MOVE_SLACK_OFF, MOVE_YAWN, MOVE_FEINT_ATTACK}
    }
};

static const struct TrainerMon sParty_BrawlyGym7[] = {
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    .iv = TRAINER_PARTY_IVS(27, 27 ,27 ,27 ,27 ,27),
    ...
    .species = SPECIES_BRELOOM,
    .ability = ABILITY_TECHNICIAN,
    .moves = {MOVE_BULLET_SEED, MOVE_SPORE, MOVE_FORCE_PALM, MOVE_MACH_PUNCH}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_MEDICHAM,
    .ability = ABILITY_PURE_POWER,
    .moves = {MOVE_ZEN_HEADBUTT, MOVE_THUNDER_PUNCH, MOVE_HIGH_JUMP_KICK, MOVE_BULLET_PUNCH}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
...
static const struct TrainerMon sParty_WattsonGym7[] = {
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    .iv = TRAINER_PARTY_IVS(27, 27 ,27 ,27 ,27 ,27),
    ...
    .species = SPECIES_MAGNEZONE,
    .ability = ABILITY_STURDY,
    .moves = {MOVE_THUNDERBOLT, MOVE_FLASH_CANNON, MOVE_THUNDER_WAVE, MOVE_METAL_SOUND}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_ELECTRODE_HISUIAN,
    .ability = ABILITY_AFTERMATH,
    .moves = {MOVE_VOLT_SWITCH, MOVE_DISCHARGE, MOVE_SWIFT, MOVE_CHLOROBLAST}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_PINCURCHIN,
    .ability = ABILITY_ELECTRIC_SURGE,
    .moves = {MOVE_BUBBLE_BEAM, MOVE_ZING_ZAP, MOVE_RECOVER, MOVE_POISON_JAB}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_MANECTRIC,
    .ability = ABILITY_STATIC,
    .moves = {MOVE_THUNDER_WAVE, MOVE_FLAMETHROWER, MOVE_CRUNCH, MOVE_DISCHARGE}
    }
};

static const struct TrainerMon sParty_FlanneryGym7[] = {
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    .iv = TRAINER_PARTY_IVS(27, 27 ,27 ,27 ,27 ,27),
    ...
    .species = SPECIES_BLAZIKEN,
    .ability = ABILITY_BLAZE,
    .moves = {MOVE_BRICK_BREAK, MOVE_BLAZE_KICK, MOVE_AERIAL_ACE, MOVE_BULK_UP}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_MAGCARGO,
    .ability = ABILITY_MAGMA_ARMOR,
    .moves = {MOVE_FLAME_BURST, MOVE_POWER_GEM, MOVE_YAWN, MOVE_SUNNY_DAY}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
...
static const struct TrainerMon sParty_WinonaGym7[] = {
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    .iv = TRAINER_PARTY_IVS(27, 27 ,27 ,27 ,27 ,27),
    ...
    .species = SPECIES_PELIPPER,
    .ability = ABILITY_KEEN_EYE,
    .moves = {MOVE_SURF, MOVE_AIR_SLASH, MOVE_TAILWIND, MOVE_PAYBACK}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_TROPIUS,
    .ability = ABILITY_CHLOROPHYLL,
    .moves = {MOVE_SOLAR_BEAM, MOVE_SYNTHESIS, MOVE_SUNNY_DAY, MOVE_AIR_SLASH}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_ALTARIA,
    .ability = ABILITY_NATURAL_CURE,
    .moves = {MOVE_FLY, MOVE_MOONBLAST, MOVE_SING, MOVE_DRAGON_PULSE}
    }
};

static const struct TrainerMon sParty_TateGym7[] = {
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    .iv = TRAINER_PARTY_IVS(27, 27 ,27 ,27 ,27 ,27),
    ...
    .species = SPECIES_GALLADE,
    .ability = ABILITY_STEADFAST,
    .moves = {MOVE_PSYCHO_CUT, MOVE_AERIAL_ACE, MOVE_BRICK_BREAK, MOVE_AQUA_CUTTER}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_MALAMAR,
    .ability = ABILITY_CONTRARY,
    .moves = {MOVE_PSYCHO_CUT, MOVE_PLUCK, MOVE_LASH_OUT, MOVE_SUPERPOWER}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_CLAYDOL,
    .ability = ABILITY_LEVITATE,
    .moves = {MOVE_EXTRASENSORY, MOVE_RAPID_SPIN, MOVE_SHADOW_BALL, MOVE_EARTH_POWER}
    }
};

static const struct TrainerMon sParty_JuanGym7[] = {
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    .iv = TRAINER_PARTY_IVS(27, 27 ,27 ,27 ,27 ,27),
    ...
    .species = SPECIES_HUNTAIL,
    .ability = ABILITY_WATER_VEIL,
    .moves = {MOVE_AQUA_TAIL, MOVE_COIL, MOVE_ICE_FANG, MOVE_SUCKER_PUNCH}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_CRAWDAUNT,
    .ability = ABILITY_ADAPTABILITY,
    .moves = {MOVE_AQUA_JET, MOVE_BUBBLE_BEAM, MOVE_SWORDS_DANCE, MOVE_CRUNCH}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_WHISCASH,
    .ability = ABILITY_HYDRATION,
    .moves = {MOVE_MUDDY_WATER, MOVE_STOMPING_TANTRUM, MOVE_AQUA_TAIL, MOVE_ZEN_HEADBUTT}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_LUDICOLO,
    .ability = ABILITY_OWN_TEMPO,
    .moves = {MOVE_SURF, MOVE_RAIN_DANCE, MOVE_ICE_PUNCH, MOVE_GIGA_DRAIN}
    }
};

static const struct TrainerMon sParty_SidneyGym7[] = {
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    .iv = TRAINER_PARTY_IVS(27, 27 ,27 ,27 ,27 ,27),
    ...
    .species = SPECIES_PERSIAN_ALOLAN,
    .ability = ABILITY_TECHNICIAN,
    .moves = {MOVE_SNARL, MOVE_SWIFT, MOVE_POWER_GEM, MOVE_PARTING_SHOT}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_SHIFTRY,
    .ability = ABILITY_WIND_RIDER,
    .moves = {MOVE_SUCKER_PUNCH, MOVE_EXTRASENSORY, MOVE_LEAF_BLADE, MOVE_NATURE_POWER}
    }
};

static const struct TrainerMon sParty_PhoebeGym7[] = {
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    .iv = TRAINER_PARTY_IVS(27, 27 ,27 ,27 ,27 ,27),
    ...
    .species = SPECIES_TREVENANT,
    .ability = ABILITY_HARVEST,
    .moves = {MOVE_PHANTOM_FORCE, MOVE_WILL_O_WISP, MOVE_HORN_LEECH, MOVE_LEECH_SEED}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_DUSCLOPS,
    .ability = ABILITY_PRESSURE,
    .moves = {MOVE_ICE_PUNCH, MOVE_SHADOW_PUNCH, MOVE_WILL_O_WISP, MOVE_PAYBACK}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_SABLEYE,
    .ability = ABILITY_MAGIC_BOUNCE,
    .moves = {MOVE_SHADOW_CLAW, MOVE_FAKE_OUT, MOVE_NIGHT_SHADE, MOVE_FOUL_PLAY}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
...
static const struct TrainerMon sParty_GlaciaGym7[] = {
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    .iv = TRAINER_PARTY_IVS(27, 27 ,27 ,27 ,27 ,27),
    ...
    .species = SPECIES_CRABOMINABLE,
    .ability = ABILITY_HYPER_CUTTER,
    .moves = {MOVE_POWER_UP_PUNCH, MOVE_ICE_HAMMER, MOVE_BRICK_BREAK, MOVE_DIZZY_PUNCH}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_GLALIE,
    .ability = ABILITY_REFRIGERATE,
    .moves = {MOVE_FREEZE_DRY, MOVE_WATER_PULSE, MOVE_CRUNCH, MOVE_HEADBUTT}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_MR_RIME,
    .ability = ABILITY_TANGLED_FEET,
    .moves = {MOVE_FREEZE_DRY, MOVE_SNOWSCAPE, MOVE_PSYCHIC, MOVE_DOUBLE_KICK}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_WALREIN,
    .ability = ABILITY_THICK_FAT,
    .moves = {MOVE_FROST_BREATH, MOVE_BRINE, MOVE_REST, MOVE_BODY_SLAM}
    },
};

static const struct TrainerMon sParty_ErikaGym7[] = {
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    .iv = TRAINER_PARTY_IVS(27, 27 ,27 ,27 ,27 ,27),
    ...
    .species = SPECIES_VICTREEBEL,
    .ability = ABILITY_CHLOROPHYLL,
    .moves = {MOVE_LEAF_BLADE, MOVE_LEECH_LIFE, MOVE_SLEEP_POWDER, MOVE_VENOSHOCK}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_EXEGGUTOR,
    .ability = ABILITY_CHLOROPHYLL,
    .moves = {MOVE_GIGA_DRAIN, MOVE_SYNTHESIS, MOVE_SUNNY_DAY, MOVE_PSYSHOCK}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_TANGROWTH,
    .ability = ABILITY_LEAF_GUARD,
    .moves = {MOVE_GIGA_DRAIN, MOVE_ANCIENT_POWER, MOVE_SLAM, MOVE_EARTHQUAKE}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_VILEPLUME,
    .ability = ABILITY_CHLOROPHYLL,
    .moves = {MOVE_GIGA_DRAIN, MOVE_GROWTH, MOVE_SLUDGE_BOMB, MOVE_MOONLIGHT}
    }
};

static const struct TrainerMon sParty_DrakeGym7[] = {
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    .iv = TRAINER_PARTY_IVS(27, 27 ,27 ,27 ,27 ,27),
    ...
    .species = SPECIES_TYRANTRUM,
    .ability = ABILITY_STRONG_JAW,
    .moves = {MOVE_DRAGON_CLAW, MOVE_ROCK_SLIDE, MOVE_CRUNCH, MOVE_ZEN_HEADBUTT}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .ability = ABILITY_POISON_POINT,
    .moves = {MOVE_WATER_PULSE, MOVE_VENOSHOCK, MOVE_DRAGON_PULSE, MOVE_TOXIC}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_SALAMENCE,
    .ability = ABILITY_ROCK_HEAD,
    .moves = {MOVE_DRAGON_CLAW, MOVE_FIRE_FANG, MOVE_CRUNCH, MOVE_ROCK_SLIDE}
    },
};

static const struct TrainerMon sParty_GiovanniGym7[] = {
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    .iv = TRAINER_PARTY_IVS(27, 27 ,27 ,27 ,27 ,27),
    ...
    .species = SPECIES_RHYDON,
    .ability = ABILITY_ROCK_HEAD,
    .moves = {MOVE_STONE_EDGE, MOVE_DRILL_RUN, MOVE_FIRE_FANG, MOVE_TAKE_DOWN}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_DUGTRIO,
    .ability = ABILITY_SAND_VEIL,
    .moves = {MOVE_EARTHQUAKE, MOVE_SUCKER_PUNCH, MOVE_AERIAL_ACE, MOVE_ROCK_SLIDE}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_MAROWAK,
    .ability = ABILITY_BATTLE_ARMOR,
    .moves = {MOVE_BONEMERANG, MOVE_THROAT_CHOP, MOVE_DOUBLE_KICK, MOVE_ROCK_TOMB}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_NIDOKING,
    .ability = ABILITY_SHEER_FORCE,
    .moves = {MOVE_POISON_TAIL, MOVE_STOMPING_TANTRUM, MOVE_MEGAHORN, MOVE_SMART_STRIKE}
    },
};

static const struct TrainerMon sParty_KogaGym7[] = {
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    .iv = TRAINER_PARTY_IVS(27, 27 ,27 ,27 ,27 ,27),
    ...
    .species = SPECIES_WEEZING,
    .ability = ABILITY_LEVITATE,
    .moves = {MOVE_SLUDGE_BOMB, MOVE_DOUBLE_HIT, MOVE_TOXIC, MOVE_FLAMETHROWER}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_DUSTOX,
    .ability = ABILITY_COMPOUND_EYES,
    .moves = {MOVE_BUG_BUZZ, MOVE_MOONLIGHT, MOVE_QUIVER_DANCE, MOVE_VENOSHOCK}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_CROBAT,
    .ability = ABILITY_INNER_FOCUS,
    .moves = {MOVE_CROSS_POISON, MOVE_FLY, MOVE_LEECH_LIFE, MOVE_CONFUSE_RAY}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_MUK,
    .ability = ABILITY_POISON_TOUCH,
    .moves = {MOVE_SLUDGE_BOMB, MOVE_MUD_BOMB, MOVE_LUNGE, MOVE_THUNDERPUNCH}
    },
};

static const struct TrainerMon sParty_StevenGym7[] = {
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    .iv = TRAINER_PARTY_IVS(27, 27 ,27 ,27 ,27 ,27),
    ...
    .species = SPECIES_FERROTHORN,
    .ability = ABILITY_IRON_BARBS,
    .moves = {MOVE_GYRO_BALL, MOVE_CURSE, MOVE_LEECH_SEED, MOVE_POWER_WHIP}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_WORMADAM,
    .ability = ABILITY_FILTER,
    .moves = {MOVE_MIRROR_SHOT, MOVE_BUG_BUZZ, MOVE_PSYCHIC, MOVE_QUIVER_DANCE}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_METAGROSS,
    .ability = ABILITY_CLEAR_BODY,
    .moves = {MOVE_TAKE_DOWN, MOVE_HAMMER_ARM, MOVE_PSYCHIC, MOVE_METEOR_MASH}
    }
};

static const struct TrainerMon sParty_BugsyGym7[] = {
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    .iv = TRAINER_PARTY_IVS(27, 27 ,27 ,27 ,27 ,27),
    ...
    .species = SPECIES_ARAQUANID,
    .ability = ABILITY_WATER_BUBBLE,
    .moves = {MOVE_LIQUIDATION, MOVE_POISON_JAB, MOVE_BUG_BITE, MOVE_CRUNCH}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_VENOMOTH,
    .ability = ABILITY_TINTED_LENS,
    .moves = {MOVE_SLUDGE_BOMB, MOVE_PSYBEAM, MOVE_QUIVER_DANCE, MOVE_SIGNAL_BEAM}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_PARASECT,
    .ability = ABILITY_EFFECT_SPORE,
    .moves = {MOVE_GIGA_DRAIN, MOVE_SPORE, MOVE_X_SCISSOR, MOVE_DIG}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_SCYTHER,
    .ability = ABILITY_TECHNICIAN,
    .moves = {MOVE_U_TURN, MOVE_WING_ATTACK, MOVE_STEEL_WING, MOVE_SLASH}
    }
};

static const struct TrainerMon sParty_ValerieGym7[] = {
        {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    .iv = TRAINER_PARTY_IVS(27, 27 ,27 ,27 ,27 ,27),
    ...
    .species = SPECIES_MR_MIME,
    .ability = ABILITY_FILTER,
    .moves = {MOVE_PSYCHIC, MOVE_LIGHT_SCREEN, MOVE_DAZZLING_GLEAM, MOVE_REFLECT}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_SHIINOTIC,
    .ability = ABILITY_EFFECT_SPORE,
    .moves = {MOVE_GIGA_DRAIN, MOVE_STRENGTH_SAP, MOVE_THUNDER_WAVE, MOVE_DRAINING_KISS}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_MAWILE,
    .ability = ABILITY_INTIMIDATE,
    .moves = {MOVE_CRUNCH, MOVE_IRON_HEAD, MOVE_PLAY_ROUGH, MOVE_SWORDS_DANCE}
    },
    {
    .ball = ITEM_POKE_BALL,
    .friendship = 255,
    ...
    .species = SPECIES_SYLVEON,
    .ability = ABILITY_PIXILATE,
    .moves = {MOVE_SWIFT, MOVE_PSYSHOCK, MOVE_SHADOW_BALL, MOVE_DRAINING_KISS}
    },
};

// Gym 8

static const struct TrainerMon sParty_RoxanneGym8[] = {
    {
    .iv = TRAINER_PARTY_IVS(31, 31 ,31 ,31 ,31 ,31),
    .nature = TRAINER_PARTY_NATURE(NATURE_HARDY),
    .heldItem = ITEM_NONE,
    ...
    .species = SPECIES_CRADILY,
    .ability = ABILITY_STORM_DRAIN,
    .moves = {MOVE_ENERGY_BALL, MOVE_ROCK_SLIDE, MOVE_BRINE, MOVE_SANDSTORM}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31 ,31 ,31 ,31 ,31),
    .nature = TRAINER_PARTY_NATURE(NATURE_HARDY),
    ...
    .species = SPECIES_RELICANTH,
    .ability = ABILITY_ROCK_HEAD,
    .moves = {MOVE_ROCK_SLIDE, MOVE_DIVE, MOVE_DOUBLE_EDGE, MOVE_BULLDOZE}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31 ,31 ,31 ,31 ,31),
    .nature = TRAINER_PARTY_NATURE(NATURE_HARDY),
    ...
    .ability = ABILITY_STURDY,
    .moves = {MOVE_STONE_EDGE, MOVE_SELF_DESTRUCT, MOVE_IRON_DEFENSE, MOVE_STOMPING_TANTRUM}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31 ,31 ,31 ,31 ,31),
    .nature = TRAINER_PARTY_NATURE(NATURE_HARDY),
    ...
    .species = SPECIES_PROBOPASS,
    .ability = ABILITY_STURDY,
    .moves = {MOVE_DISCHARGE, MOVE_POWER_GEM, MOVE_FLASH_CANNON, MOVE_TRI_ATTACK}
    }
};

static const struct TrainerMon sParty_NormanGym8[] = {
    {
    .iv = TRAINER_PARTY_IVS(31, 31 ,31 ,31 ,31 ,31),
    .nature = TRAINER_PARTY_NATURE(NATURE_HARDY),
    .heldItem = ITEM_NONE,
    ...
    .species = SPECIES_EXPLOUD,
    .ability = ABILITY_SCRAPPY,
    .moves = {MOVE_HYPER_VOICE, MOVE_SURF, MOVE_CRUNCH, MOVE_REST}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31 ,31 ,31 ,31 ,31),
    .nature = TRAINER_PARTY_NATURE(NATURE_HARDY),
    ...
    .species = SPECIES_BIBAREL,
    .ability = ABILITY_UNAWARE,
    .moves = {MOVE_SUPER_FANG, MOVE_SCALD, MOVE_ROCK_CLIMB, MOVE_HEADBUTT}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31 ,31 ,31 ,31 ,31),
    .nature = TRAINER_PARTY_NATURE(NATURE_HARDY),
    ...
    .species = SPECIES_LINOONE,
    .ability = ABILITY_QUICK_FEET,
    .moves = {MOVE_DOUBLE_EDGE, MOVE_BELLY_DRUM, MOVE_SHADOW_CLAW, MOVE_PIN_MISSILE}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31 ,31 ,31 ,31 ,31),
    .nature = TRAINER_PARTY_NATURE(NATURE_HARDY),
    ...
    .moves = {MOVE_THUNDERBOLT, MOVE_LIGHT_SCREEN, MOVE_SOLAR_BEAM, MOVE_SUNNY_DAY}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31 ,31 ,31 ,31 ,31),
    .nature = TRAINER_PARTY_NATURE(NATURE_HARDY),
    ...
    .species = SPECIES_SLAKING,
    .ability = ABILITY_TRUANT,
    .moves = {MOVE_TAKE_DOWN, MOVE_SLACK_OFF, MOVE_YAWN, MOVE_THROAT_CHOP}
    }
};

static const struct TrainerMon sParty_BrawlyGym8[] = {
    {
    .iv = TRAINER_PARTY_IVS(31, 31 ,31 ,31 ,31 ,31),
    .nature = TRAINER_PARTY_NATURE(NATURE_HARDY),
    .heldItem = ITEM_NONE,
    ...
    .species = SPECIES_BRELOOM,
    .ability = ABILITY_TECHNICIAN,
    .moves = {MOVE_BULLET_SEED, MOVE_FORCE_PALM, MOVE_MACH_PUNCH, MOVE_SPORE}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31 ,31 ,31 ,31 ,31),
    .nature = TRAINER_PARTY_NATURE(NATURE_HARDY),
    ...
    .species = SPECIES_MEDICHAM,
    .ability = ABILITY_PURE_POWER,
    .moves = {MOVE_ZEN_HEADBUTT, MOVE_HIGH_JUMP_KICK, MOVE_THUNDER_PUNCH, MOVE_BULLET_PUNCH}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31 ,31 ,31 ,31 ,31),
    .nature = TRAINER_PARTY_NATURE(NATURE_HARDY),
    ...
    .species = SPECIES_HITMONTOP,
    .ability = ABILITY_INTIMIDATE,
    .moves = {MOVE_TRIPLE_KICK, MOVE_RAPID_SPIN, MOVE_FOCUS_ENERGY, MOVE_COUNTER}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31 ,31 ,31 ,31 ,31),
    .nature = TRAINER_PARTY_NATURE(NATURE_HARDY),
    ...
    .moves = {MOVE_CLOSE_COMBAT, MOVE_BULK_UP, MOVE_U_TURN, MOVE_SMACK_DOWN}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31 ,31 ,31 ,31 ,31),
    .nature = TRAINER_PARTY_NATURE(NATURE_HARDY),
    ...
    .species = SPECIES_HARIYAMA,
    .ability = ABILITY_GUTS,
    .moves = {MOVE_DRAIN_PUNCH, MOVE_BULK_UP, MOVE_KNOCK_OFF, MOVE_DIG}
    }
};

static const struct TrainerMon sParty_WattsonGym8[] = {
    {
    .iv = TRAINER_PARTY_IVS(31, 31 ,31 ,31 ,31 ,31),
    .nature = TRAINER_PARTY_NATURE(NATURE_HARDY),
    .heldItem = ITEM_NONE,
    ...
    .species = SPECIES_ELECTRODE_HISUIAN,
    .ability = ABILITY_AFTERMATH,
    .moves = {MOVE_DISCHARGE, MOVE_EXPLOSION, MOVE_VOLT_SWITCH, MOVE_CHLOROBLAST}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31 ,31 ,31 ,31 ,31),
    .nature = TRAINER_PARTY_NATURE(NATURE_HARDY),
    ...
    .species = SPECIES_PINCURCHIN,
    .ability = ABILITY_ELECTRIC_SURGE,
    .moves = {MOVE_ZING_ZAP, MOVE_POISON_JAB, MOVE_RECOVER, MOVE_CHILLING_WATER}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31 ,31 ,31 ,31 ,31),
    .nature = TRAINER_PARTY_NATURE(NATURE_HARDY),
    ...
    .moves = {MOVE_THUNDERBOLT, MOVE_SURF, MOVE_IRON_TAIL, MOVE_PSYCHIC}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31 ,31 ,31 ,31 ,31),
    .nature = TRAINER_PARTY_NATURE(NATURE_HARDY),
    ...
    .species = SPECIES_MANECTRIC,
    .ability = ABILITY_STATIC,
    .moves = {MOVE_DISCHARGE, MOVE_FLAMETHROWER, MOVE_CRUNCH, MOVE_THUNDER_WAVE}
    }
};

static const struct TrainerMon sParty_FlanneryGym8[] = {
    {
    .iv = TRAINER_PARTY_IVS(31, 31 ,31 ,31 ,31 ,31),
    .nature = TRAINER_PARTY_NATURE(NATURE_HARDY),
    .heldItem = ITEM_NONE,
    ...
    .species = SPECIES_CAMERUPT,
    .ability = ABILITY_SHEER_FORCE,
    .moves = {MOVE_LAVA_PLUME, MOVE_EARTH_POWER, MOVE_ROCK_SLIDE, MOVE_CURSE}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31 ,31 ,31 ,31 ,31),
    .nature = TRAINER_PARTY_NATURE(NATURE_HARDY),
    ...
    .species = SPECIES_MAGCARGO,
    .ability = ABILITY_MAGMA_ARMOR,
    .moves = {MOVE_FLAMETHROWER, MOVE_POWER_GEM, MOVE_EARTH_POWER, MOVE_YAWN}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31 ,31 ,31 ,31 ,31),
    .nature = TRAINER_PARTY_NATURE(NATURE_HARDY),
    ...
    .ability = ABILITY_RIVALRY,
    .moves = {MOVE_FLAMETHROWER, MOVE_HYPER_VOICE, MOVE_CRUNCH, MOVE_SUNNY_DAY}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31 ,31 ,31 ,31 ,31),
    .nature = TRAINER_PARTY_NATURE(NATURE_HARDY),
    ...
    .species = SPECIES_TORKOAL,
    .ability = ABILITY_WHITE_SMOKE,
    .moves = {MOVE_OVERHEAT, MOVE_BODY_SLAM, MOVE_BODY_PRESS, MOVE_SUNNY_DAY}
    }
};

static const struct TrainerMon sParty_WinonaGym8[] = {
    {
    .iv = TRAINER_PARTY_IVS(31, 31 ,31 ,31 ,31 ,31),
    .nature = TRAINER_PARTY_NATURE(NATURE_HARDY),
    .heldItem = ITEM_NONE,
    ...
    .species = SPECIES_TROPIUS,
    .ability = ABILITY_CHLOROPHYLL,
    .moves = {MOVE_SOLAR_BEAM, MOVE_SYNTHESIS, MOVE_AIR_SLASH, MOVE_SUNNY_DAY}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31 ,31 ,31 ,31 ,31),
    .nature = TRAINER_PARTY_NATURE(NATURE_HARDY),
    ...
    .species = SPECIES_SWELLOW,
    .ability = ABILITY_SCRAPPY,
    .moves = {MOVE_BRAVE_BIRD, MOVE_DOUBLE_TEAM, MOVE_STEEL_WING, MOVE_FACADE}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31 ,31 ,31 ,31 ,31),
    .nature = TRAINER_PARTY_NATURE(NATURE_HARDY),
    ...
    .ability = ABILITY_INTIMIDATE,
    .moves = {MOVE_CLOSE_COMBAT, MOVE_TAKE_DOWN, MOVE_WING_ATTACK, MOVE_ROOST}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31 ,31 ,31 ,31 ,31),
    .nature = TRAINER_PARTY_NATURE(NATURE_HARDY),
    ...
    .species = SPECIES_ALTARIA,
    .ability = ABILITY_NATURAL_CURE,
    .moves = {MOVE_FLY, MOVE_MOONBLAST, MOVE_DRAGON_PULSE, MOVE_PERISH_SONG}
    }
};

static const struct TrainerMon sParty_TateGym8[] = {
    {
    .iv = TRAINER_PARTY_IVS(31, 31 ,31 ,31 ,31 ,31),
    .nature = TRAINER_PARTY_NATURE(NATURE_HARDY),
    .heldItem = ITEM_NONE,
    ...
    .species = SPECIES_GALLADE,
    .ability = ABILITY_STEADFAST,
    .moves = {MOVE_PSYCHO_CUT, MOVE_AERIAL_ACE, MOVE_SACRED_SWORD, MOVE_AQUA_CUTTER}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31 ,31 ,31 ,31 ,31),
    .nature = TRAINER_PARTY_NATURE(NATURE_HARDY),
    ...
    .species = SPECIES_SOLROCK,
    .ability = ABILITY_LEVITATE,
    .moves = {MOVE_ROCK_SLIDE, MOVE_ZEN_HEADBUTT, MOVE_COSMIC_POWER, MOVE_FLARE_BLITZ}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31 ,31 ,31 ,31 ,31),
    .nature = TRAINER_PARTY_NATURE(NATURE_HARDY),
    ...
    .species = SPECIES_MALAMAR,
    .ability = ABILITY_CONTRARY,
    .moves = {MOVE_PSYCHO_CUT, MOVE_PLUCK, MOVE_SUPERPOWER, MOVE_LASH_OUT}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31 ,31 ,31 ,31 ,31),
    .nature = TRAINER_PARTY_NATURE(NATURE_HARDY),
    ...
    .species = SPECIES_GRUMPIG,
    .ability = ABILITY_THICK_FAT,
    .moves = {MOVE_PSYCHIC, MOVE_TEETER_DANCE, MOVE_POWER_GEM, MOVE_BOUNCE}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31 ,31 ,31 ,31 ,31),
    .nature = TRAINER_PARTY_NATURE(NATURE_HARDY),
    ...
    .species = SPECIES_CLAYDOL,
    .ability = ABILITY_LEVITATE,
    .moves = {MOVE_EXTRASENSORY, MOVE_EXPLOSION, MOVE_EARTH_POWER, MOVE_SHADOW_BALL}
    }
};

static const struct TrainerMon sParty_JuanGym8[] = {
    {
    .iv = TRAINER_PARTY_IVS(31, 31 ,31 ,31 ,31 ,31),
    .nature = TRAINER_PARTY_NATURE(NATURE_HARDY),
    .heldItem = ITEM_NONE,
    ...
    .species = SPECIES_HUNTAIL,
    .ability = ABILITY_WATER_VEIL,
    .moves = {MOVE_AQUA_TAIL, MOVE_SUCKER_PUNCH, MOVE_COIL, MOVE_ICE_FANG}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31 ,31 ,31 ,31 ,31),
    .nature = TRAINER_PARTY_NATURE(NATURE_HARDY),
    ...
    .species = SPECIES_CRAWDAUNT,
    .ability = ABILITY_HYPER_CUTTER,
    .moves = {MOVE_CRABHAMMER, MOVE_CRUNCH, MOVE_SWORDS_DANCE, MOVE_AQUA_JET}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31 ,31 ,31 ,31 ,31),
    .nature = TRAINER_PARTY_NATURE(NATURE_HARDY),
    ...
    .species = SPECIES_WHISCASH,
    .ability = ABILITY_HYDRATION,
    .moves = {MOVE_MUDDY_WATER, MOVE_STOMPING_TANTRUM, MOVE_ZEN_HEADBUTT, MOVE_DRAGON_DANCE}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31 ,31 ,31 ,31 ,31),
    .nature = TRAINER_PARTY_NATURE(NATURE_HARDY),
    ...
    .moves = {MOVE_SCALD, MOVE_PSYCHIC, MOVE_DRAINING_KISS, MOVE_CAPTIVATE}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31 ,31 ,31 ,31 ,31),
    .nature = TRAINER_PARTY_NATURE(NATURE_HARDY),
    ...
    .species = SPECIES_LUDICOLO,
    .ability = ABILITY_SWIFT_SWIM,
    .moves = {MOVE_ENERGY_BALL, MOVE_ICE_PUNCH, MOVE_SURF, MOVE_RAIN_DANCE}
    }
};

static const struct TrainerMon sParty_SidneyGym8[] = {
    {
    .iv = TRAINER_PARTY_IVS(31, 31 ,31 ,31 ,31 ,31),
    .nature = TRAINER_PARTY_NATURE(NATURE_HARDY),
    .heldItem = ITEM_NONE,
    ...
    .species = SPECIES_PERSIAN_ALOLAN,
    .ability = ABILITY_TECHNICIAN,
    .moves = {MOVE_SNARL, MOVE_TRAILBLAZE, MOVE_POWER_GEM, MOVE_SWIFT}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31 ,31 ,31 ,31 ,31),
    .nature = TRAINER_PARTY_NATURE(NATURE_HARDY),
    ...
    .species = SPECIES_MIGHTYENA,
    .ability = ABILITY_INTIMIDATE,
    .moves = {MOVE_CRUNCH, MOVE_PLAY_ROUGH, MOVE_SWAGGER, MOVE_FIRE_FANG}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31 ,31 ,31 ,31 ,31),
    .nature = TRAINER_PARTY_NATURE(NATURE_HARDY),
    ...
    .moves = {MOVE_ROCK_SLIDE, MOVE_EARTHQUAKE, MOVE_CRUNCH, MOVE_FLAMETHROWER}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31 ,31 ,31 ,31 ,31),
    .nature = TRAINER_PARTY_NATURE(NATURE_HARDY),
    ...
    .species = SPECIES_SHIFTRY,
    .ability = ABILITY_WIND_RIDER,
    .moves = {MOVE_SUCKER_PUNCH, MOVE_TAILWIND, MOVE_LEAF_BLADE, MOVE_EXTRASENSORY}
    }
};

static const struct TrainerMon sParty_PhoebeGym8[] = {
    {
    .iv = TRAINER_PARTY_IVS(31, 31 ,31 ,31 ,31 ,31),
    .nature = TRAINER_PARTY_NATURE(NATURE_HARDY),
    .heldItem = ITEM_NONE,
    ...
    .species = SPECIES_TREVENANT,
    .ability = ABILITY_NATURAL_CURE,
    .moves = {MOVE_PHANTOM_FORCE, MOVE_LEECH_SEED, MOVE_HORN_LEECH, MOVE_WILL_O_WISP}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31 ,31 ,31 ,31 ,31),
    .nature = TRAINER_PARTY_NATURE(NATURE_HARDY),
    ...
    .species = SPECIES_BANETTE,
    .ability = ABILITY_CURSED_BODY,
    .moves = {MOVE_CURSE, MOVE_SHADOW_SNEAK, MOVE_KNOCK_OFF, MOVE_PHANTOM_FORCE}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31 ,31 ,31 ,31 ,31),
    .nature = TRAINER_PARTY_NATURE(NATURE_HARDY),
    ...
    .moves = {MOVE_FOUL_PLAY, MOVE_SHADOW_CLAW, MOVE_NIGHT_SHADE, MOVE_FAKE_OUT}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31 ,31 ,31 ,31 ,31),
    .nature = TRAINER_PARTY_NATURE(NATURE_HARDY),
    ...
    .moves = {MOVE_REVELATION_DANCE, MOVE_ACROBATICS, MOVE_TEETER_DANCE, MOVE_U_TURN}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31 ,31 ,31 ,31 ,31),
    .nature = TRAINER_PARTY_NATURE(NATURE_HARDY),
    ...
    .ability = ABILITY_PRESSURE,
    .moves = {MOVE_SHADOW_PUNCH, MOVE_PAYBACK, MOVE_ICE_PUNCH, MOVE_FIRE_PUNCH}
    }
};

static const struct TrainerMon sParty_GlaciaGym8[] = {
    {
    .iv = TRAINER_PARTY_IVS(31, 31 ,31 ,31 ,31 ,31),
    .nature = TRAINER_PARTY_NATURE(NATURE_HARDY),
    .heldItem = ITEM_NONE,
    ...
    .moves = {MOVE_ICE_HAMMER, MOVE_BRICK_BREAK, MOVE_THUNDER_PUNCH, MOVE_DIZZY_PUNCH}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31 ,31 ,31 ,31 ,31),
    .nature = TRAINER_PARTY_NATURE(NATURE_HARDY),
    ...
    .species = SPECIES_GLALIE,
    .ability = ABILITY_REFRIGERATE,
    .moves = {MOVE_FREEZE_DRY, MOVE_HEADBUTT, MOVE_CRUNCH, MOVE_EARTHQUAKE}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31 ,31 ,31 ,31 ,31),
    .nature = TRAINER_PARTY_NATURE(NATURE_HARDY),
    ...
    .species = SPECIES_MR_RIME,
    .ability = ABILITY_TANGLED_FEET,
    .moves = {MOVE_FREEZE_DRY, MOVE_PSYCHIC, MOVE_DAZZLING_GLEAM, MOVE_SNOWSCAPE}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31 ,31 ,31 ,31 ,31),
    .nature = TRAINER_PARTY_NATURE(NATURE_HARDY),
    ...
    .moves = {MOVE_ICE_PUNCH, MOVE_THRASH, MOVE_FIRE_PUNCH, MOVE_ZEN_HEADBUTT}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31 ,31 ,31 ,31 ,31),
    .nature = TRAINER_PARTY_NATURE(NATURE_HARDY),
    ...
    .species = SPECIES_WALREIN,
    .ability = ABILITY_THICK_FAT,
    .moves = {MOVE_FROST_BREATH, MOVE_SURF, MOVE_REST, MOVE_BODY_SLAM}
    }
};

static const struct TrainerMon sParty_ErikaGym8[] = {
    {
    .iv = TRAINER_PARTY_IVS(31, 31 ,31 ,31 ,31 ,31),
    .nature = TRAINER_PARTY_NATURE(NATURE_HARDY),
    .heldItem = ITEM_NONE,
    ...
    .species = SPECIES_VICTREEBEL,
    .ability = ABILITY_CHLOROPHYLL,
    .moves = {MOVE_LEAF_BLADE, MOVE_SLEEP_POWDER, MOVE_POISON_JAB, MOVE_LEECH_LIFE}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31 ,31 ,31 ,31 ,31),
    .nature = TRAINER_PARTY_NATURE(NATURE_HARDY),
    ...
    .species = SPECIES_EXEGGUTOR,
    .ability = ABILITY_CHLOROPHYLL,
    .moves = {MOVE_EGG_BOMB, MOVE_SYNTHESIS, MOVE_PSYSHOCK, MOVE_SUNNY_DAY}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31 ,31 ,31 ,31 ,31),
    .nature = TRAINER_PARTY_NATURE(NATURE_HARDY),
    ...
    .species = SPECIES_TANGROWTH,
    .ability = ABILITY_CHLOROPHYLL,
    .moves = {MOVE_POWER_WHIP, MOVE_ANCIENT_POWER, MOVE_SLAM, MOVE_EARTHQUAKE}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31 ,31 ,31 ,31 ,31),
    .nature = TRAINER_PARTY_NATURE(NATURE_HARDY),
    ...
    .moves = {MOVE_ENERGY_BALL, MOVE_TAKE_DOWN, MOVE_SLUDGE_BOMB, MOVE_SUNNY_DAY}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31 ,31 ,31 ,31 ,31),
    .nature = TRAINER_PARTY_NATURE(NATURE_HARDY),
    ...
    .species = SPECIES_VILEPLUME,
    .ability = ABILITY_EFFECT_SPORE,
    .moves = {MOVE_GIGA_DRAIN, MOVE_MOONLIGHT, MOVE_SLUDGE_BOMB, MOVE_MOONBLAST}
    }
};

static const struct TrainerMon sParty_DrakeGym8[] = {
    {
    .iv = TRAINER_PARTY_IVS(31, 31 ,31 ,31 ,31 ,31),
    .nature = TRAINER_PARTY_NATURE(NATURE_HARDY),
    .heldItem = ITEM_NONE,
    ...
    .species = SPECIES_TYRANTRUM,
    .ability = ABILITY_STRONG_JAW,
    .moves = {MOVE_DRAGON_CLAW, MOVE_STONE_EDGE, MOVE_CRUNCH, MOVE_ZEN_HEADBUTT}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31 ,31 ,31 ,31 ,31),
    .nature = TRAINER_PARTY_NATURE(NATURE_HARDY),
    ...
    .species = SPECIES_DRAGALGE,
    .ability = ABILITY_POISON_POINT,
    .moves = {MOVE_WATER_PULSE, MOVE_SLUDGE_WAVE, MOVE_TOXIC, MOVE_DRAGON_PULSE}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31 ,31 ,31 ,31 ,31),
    .nature = TRAINER_PARTY_NATURE(NATURE_HARDY),
    ...
    .species = SPECIES_FLYGON,
    .ability = ABILITY_LEVITATE,
    .moves = {MOVE_DRAGON_CLAW, MOVE_EARTHQUAKE, MOVE_BUG_BUZZ, MOVE_ROCK_SLIDE}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31 ,31 ,31 ,31 ,31),
    .nature = TRAINER_PARTY_NATURE(NATURE_HARDY),
    ...
    .ability = ABILITY_SHELL_ARMOR,
    .moves = {MOVE_SHELL_TRAP, MOVE_DRAGON_PULSE, MOVE_IRON_HEAD, MOVE_REST}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31 ,31 ,31 ,31 ,31),
    .nature = TRAINER_PARTY_NATURE(NATURE_HARDY),
    ...
    .species = SPECIES_SALAMENCE,
    .ability = ABILITY_INTIMIDATE,
    .moves = {MOVE_DRAGON_CLAW, MOVE_FLAMETHROWER, MOVE_CRUNCH, MOVE_ROCK_SLIDE}
    }
};

static const struct TrainerMon sParty_GiovanniGym8[] = {
    {
    .iv = TRAINER_PARTY_IVS(31, 31 ,31 ,31 ,31 ,31),
    .nature = TRAINER_PARTY_NATURE(NATURE_HARDY),
    .heldItem = ITEM_NONE,
    ...
    .species = SPECIES_MAROWAK,
    .ability = ABILITY_BATTLE_ARMOR,
    .moves = {MOVE_BONEMERANG, MOVE_THROAT_CHOP, MOVE_ROCK_CLIMB, MOVE_DOUBLE_KICK}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31 ,31 ,31 ,31 ,31),
    .nature = TRAINER_PARTY_NATURE(NATURE_HARDY),
    ...
    .species = SPECIES_DUGTRIO,
    .ability = ABILITY_ARENA_TRAP,
    .moves = {MOVE_EARTHQUAKE, MOVE_NIGHT_SLASH, MOVE_AERIAL_ACE, MOVE_ROCK_SLIDE}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31 ,31 ,31 ,31 ,31),
    .nature = TRAINER_PARTY_NATURE(NATURE_HARDY),
    ...
    .ability = ABILITY_POISON_TOUCH,
    .moves = {MOVE_MUDDY_WATER, MOVE_DRAIN_PUNCH, MOVE_HYPER_VOICE, MOVE_EARTHQUAKE}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31 ,31 ,31 ,31 ,31),
    .nature = TRAINER_PARTY_NATURE(NATURE_HARDY),
    ...
    .ability = ABILITY_ROCK_HEAD,
    .moves = {MOVE_STONE_EDGE, MOVE_DRILL_RUN, MOVE_TAKE_DOWN, MOVE_MEGAHORN}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31 ,31 ,31 ,31 ,31),
    .nature = TRAINER_PARTY_NATURE(NATURE_HARDY),
    ...
    .species = SPECIES_NIDOKING,
    .ability = ABILITY_SHEER_FORCE,
    .moves = {MOVE_STOMPING_TANTRUM, MOVE_SLUDGE_BOMB, MOVE_MEGAHORN, MOVE_SMART_STRIKE}
    }
};

static const struct TrainerMon sParty_KogaGym8[] = {
    {
    .iv = TRAINER_PARTY_IVS(31, 31 ,31 ,31 ,31 ,31),
    .nature = TRAINER_PARTY_NATURE(NATURE_HARDY),
    .heldItem = ITEM_NONE,
    ...
    .species = SPECIES_WEEZING,
    .ability = ABILITY_LEVITATE,
    .moves = {MOVE_SLUDGE_BOMB, MOVE_FLAMETHROWER, MOVE_DOUBLE_HIT, MOVE_TOXIC}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31 ,31 ,31 ,31 ,31),
    .nature = TRAINER_PARTY_NATURE(NATURE_HARDY),
    ...
    .species = SPECIES_DUSTOX,
    .ability = ABILITY_COMPOUND_EYES,
    .moves = {MOVE_VENOSHOCK, MOVE_MOONLIGHT, MOVE_BUG_BUZZ, MOVE_QUIVER_DANCE}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31 ,31 ,31 ,31 ,31),
    .nature = TRAINER_PARTY_NATURE(NATURE_HARDY),
    ...
    .ability = ABILITY_AFTERMATH,
    .moves = {MOVE_POISON_JAB, MOVE_NIGHT_SLASH, MOVE_SLASH, MOVE_FLAMETHROWER}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31 ,31 ,31 ,31 ,31),
    .nature = TRAINER_PARTY_NATURE(NATURE_HARDY),
    ...
    .species = SPECIES_MUK,
    .ability = ABILITY_POISON_TOUCH,
    .moves = {MOVE_GUNK_SHOT, MOVE_THUNDER_PUNCH, MOVE_MUD_BOMB, MOVE_LUNGE}
    }
};

static const struct TrainerMon sParty_StevenGym8[] = {
    {
    .iv = TRAINER_PARTY_IVS(31, 31 ,31 ,31 ,31 ,31),
    .nature = TRAINER_PARTY_NATURE(NATURE_HARDY),
    .heldItem = ITEM_NONE,
    ...
    .species = SPECIES_AGGRON,
    .ability = ABILITY_STURDY,
    .moves = {MOVE_ROCK_CLIMB, MOVE_IRON_TAIL, MOVE_TAKE_DOWN, MOVE_AUTOTOMIZE}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31 ,31 ,31 ,31 ,31),
    .nature = TRAINER_PARTY_NATURE(NATURE_HARDY),
    ...
    .species = SPECIES_FERROTHORN,
    .ability = ABILITY_IRON_BARBS,
    .moves = {MOVE_GYRO_BALL, MOVE_CURSE, MOVE_POWER_WHIP, MOVE_LEECH_SEED}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31 ,31 ,31 ,31 ,31),
    .nature = TRAINER_PARTY_NATURE(NATURE_HARDY),
    ...
    .species = SPECIES_WORMADAM,
    .ability = ABILITY_FILTER,
    .moves = {MOVE_MIRROR_SHOT, MOVE_PSYCHIC, MOVE_BUG_BUZZ, MOVE_QUIVER_DANCE}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31 ,31 ,31 ,31 ,31),
    .nature = TRAINER_PARTY_NATURE(NATURE_HARDY),
    ...
    .moves = {MOVE_STRENGTH, MOVE_HEAVY_SLAM, MOVE_HIGH_HORSEPOWER, MOVE_PLAY_ROUGH}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31 ,31 ,31 ,31 ,31),
    .nature = TRAINER_PARTY_NATURE(NATURE_HARDY),
    ...
    .species = SPECIES_METAGROSS,
    .ability = ABILITY_CLEAR_BODY,
    .moves = {MOVE_ZEN_HEADBUTT, MOVE_METEOR_MASH, MOVE_TAKE_DOWN, MOVE_HAMMER_ARM}
    }
};

static const struct TrainerMon sParty_BugsyGym8[] = {
    {
    .iv = TRAINER_PARTY_IVS(31, 31 ,31 ,31 ,31 ,31),
    .nature = TRAINER_PARTY_NATURE(NATURE_HARDY),
    .heldItem = ITEM_NONE,
    ...
    .species = SPECIES_ARAQUANID,
    .ability = ABILITY_WATER_BUBBLE,
    .moves = {MOVE_LIQUIDATION, MOVE_CRUNCH, MOVE_LEECH_LIFE, MOVE_POISON_JAB}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31 ,31 ,31 ,31 ,31),
    .nature = TRAINER_PARTY_NATURE(NATURE_HARDY),
    ...
    .species = SPECIES_VENOMOTH,
    .ability = ABILITY_TINTED_LENS,
    .moves = {MOVE_BUG_BUZZ, MOVE_PSYBEAM, MOVE_SLUDGE_BOMB, MOVE_QUIVER_DANCE}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31 ,31 ,31 ,31 ,31),
    .nature = TRAINER_PARTY_NATURE(NATURE_HARDY),
    ...
    .moves = {MOVE_SUPERPOWER, MOVE_EARTHQUAKE, MOVE_X_SCISSOR, MOVE_ROCK_TOMB}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31 ,31 ,31 ,31 ,31),
    .nature = TRAINER_PARTY_NATURE(NATURE_HARDY),
    ...
    .species = SPECIES_SCYTHER,
    .ability = ABILITY_TECHNICIAN,
    .moves = {MOVE_WING_ATTACK, MOVE_NIGHT_SLASH, MOVE_U_TURN, MOVE_STEEL_WING}
    }
};

static const struct TrainerMon sParty_ValerieGym8[] = {
    {
    .iv = TRAINER_PARTY_IVS(31, 31 ,31 ,31 ,31 ,31),
    .nature = TRAINER_PARTY_NATURE(NATURE_HARDY),
    .heldItem = ITEM_NONE,
    ...
    .species = SPECIES_SHIINOTIC,
    .ability = ABILITY_EFFECT_SPORE,
    .moves = {MOVE_GIGA_DRAIN, MOVE_STRENGTH_SAP, MOVE_MOONBLAST, MOVE_THUNDER_WAVE}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31 ,31 ,31 ,31 ,31),
    .nature = TRAINER_PARTY_NATURE(NATURE_HARDY),
    ...
    .species = SPECIES_MAWILE,
    .ability = ABILITY_INTIMIDATE,
    .moves = {MOVE_IRON_HEAD, MOVE_CRUNCH, MOVE_PLAY_ROUGH, MOVE_SWORDS_DANCE}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31 ,31 ,31 ,31 ,31),
    .nature = TRAINER_PARTY_NATURE(NATURE_HARDY),
    ...
    .moves = {MOVE_MOONBLAST, MOVE_FLAMETHROWER, MOVE_METEOR_MASH, MOVE_ICE_BEAM}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31 ,31 ,31 ,31 ,31),
    .nature = TRAINER_PARTY_NATURE(NATURE_HARDY),
...
static const struct TrainerMon sParty_RoxanneElite4[] = {
    ...
    .species = SPECIES_ARMALDO,
    .ability = ABILITY_BATTLE_ARMOR,
    .moves = {MOVE_X_SCISSOR, MOVE_ROCK_SLIDE, MOVE_STEALTH_ROCK, MOVE_LIQUIDATION}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31 ,31 ,31 ,31 ,31),
    .nature = TRAINER_PARTY_NATURE(NATURE_HARDY),
    ...
    .species = SPECIES_CRADILY,
    .ability = ABILITY_STORM_DRAIN,
    .moves = {MOVE_ENERGY_BALL, MOVE_ROCK_SLIDE, MOVE_SLUDGE_BOMB, MOVE_SANDSTORM}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31 ,31 ,31 ,31 ,31),
    .nature = TRAINER_PARTY_NATURE(NATURE_HARDY),
    ...
    .species = SPECIES_GIGALITH,
    .ability = ABILITY_STURDY,
    .moves = {MOVE_STONE_EDGE, MOVE_SELF_DESTRUCT, MOVE_IRON_DEFENSE, MOVE_EARTHQUAKE}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31 ,31 ,31 ,31 ,31),
    .nature = TRAINER_PARTY_NATURE(NATURE_HARDY),
    ...
    .species = SPECIES_RELICANTH,
    .ability = ABILITY_ROCK_HEAD,
    .moves = {MOVE_HEAD_SMASH, MOVE_DIVE, MOVE_DOUBLE_EDGE, MOVE_BULLDOZE}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31 ,31 ,31 ,31 ,31),
    .nature = TRAINER_PARTY_NATURE(NATURE_HARDY),
    ...
    .species = SPECIES_PROBOPASS,
    .ability = ABILITY_STURDY,
    .moves = {MOVE_DISCHARGE, MOVE_POWER_GEM, MOVE_FLASH_CANNON, MOVE_BODY_PRESS}
    }
};

static const struct TrainerMon sParty_NormanElite4[] = {
    {
    .iv = TRAINER_PARTY_IVS(31, 31 ,31 ,31 ,31 ,31),
    .nature = TRAINER_PARTY_NATURE(NATURE_HARDY),
    .heldItem = ITEM_NONE,
    ...
    .species = SPECIES_LINOONE,
    .ability = ABILITY_QUICK_FEET,
    .moves = {MOVE_DOUBLE_EDGE, MOVE_BELLY_DRUM, MOVE_SHADOW_CLAW, MOVE_EXTREME_SPEED}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31 ,31 ,31 ,31 ,31),
    .nature = TRAINER_PARTY_NATURE(NATURE_HARDY),
    ...
    .species = SPECIES_BIBAREL,
    .ability = ABILITY_UNAWARE,
    .moves = {MOVE_SUPER_FANG, MOVE_SCALD, MOVE_ROCK_CLIMB, MOVE_AQUA_JET}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31 ,31 ,31 ,31 ,31),
    .nature = TRAINER_PARTY_NATURE(NATURE_HARDY),
    ...
    .species = SPECIES_EXPLOUD,
    .ability = ABILITY_SCRAPPY,
    .moves = {MOVE_BOOMBURST, MOVE_SURF, MOVE_CRUNCH, MOVE_REST}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31 ,31 ,31 ,31 ,31),
    .nature = TRAINER_PARTY_NATURE(NATURE_HARDY),
...
static const struct TrainerMon sParty_BrawlyElite4[] = {
    {
    .iv = TRAINER_PARTY_IVS(31, 31 ,31 ,31 ,31 ,31),
    .nature = TRAINER_PARTY_NATURE(NATURE_HARDY),
    .heldItem = ITEM_NONE,
    ...
    .species = SPECIES_HITMONTOP,
    .ability = ABILITY_INTIMIDATE,
    .moves = {MOVE_TRIPLE_KICK, MOVE_RAPID_SPIN, MOVE_ICE_SPINNER, MOVE_COUNTER}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31 ,31 ,31 ,31 ,31),
    .nature = TRAINER_PARTY_NATURE(NATURE_HARDY),
    ...
    .species = SPECIES_MEDICHAM,
    .ability = ABILITY_PURE_POWER,
    .moves = {MOVE_ZEN_HEADBUTT, MOVE_HIGH_JUMP_KICK, MOVE_THUNDER_PUNCH, MOVE_ICE_PUNCH}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31 ,31 ,31 ,31 ,31),
    .nature = TRAINER_PARTY_NATURE(NATURE_HARDY),
    ...
    .species = SPECIES_HARIYAMA,
    .ability = ABILITY_GUTS,
    .moves = {MOVE_DRAIN_PUNCH, MOVE_BULK_UP, MOVE_KNOCK_OFF, MOVE_HEADLONG_RUSH}
    }
};

static const struct TrainerMon sParty_WattsonElite4[] = {
    {
    .iv = TRAINER_PARTY_IVS(31, 31 ,31 ,31 ,31 ,31),
    .nature = TRAINER_PARTY_NATURE(NATURE_HARDY),
    .heldItem = ITEM_NONE,
    ...
    .species = SPECIES_MAGNEZONE,
    .ability = ABILITY_STURDY,
    .moves = {MOVE_THUNDERBOLT, MOVE_FLASH_CANNON, MOVE_HYPER_BEAM, MOVE_METAL_SOUND}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31 ,31 ,31 ,31 ,31),
    .nature = TRAINER_PARTY_NATURE(NATURE_HARDY),
    ...
    .species = SPECIES_ELECTRODE_HISUIAN,
    .ability = ABILITY_AFTERMATH,
    .moves = {MOVE_THUNDERBOLT, MOVE_EXPLOSION, MOVE_VOLT_SWITCH, MOVE_CHLOROBLAST}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31 ,31 ,31 ,31 ,31),
    .nature = TRAINER_PARTY_NATURE(NATURE_HARDY),
...
static const struct TrainerMon sParty_FlanneryElite4[] = {
    {
    .iv = TRAINER_PARTY_IVS(31, 31 ,31 ,31 ,31 ,31),
    .nature = TRAINER_PARTY_NATURE(NATURE_HARDY),
    .heldItem = ITEM_NONE,
    ...
    .species = SPECIES_PYROAR,
    .ability = ABILITY_RIVALRY,
    .moves = {MOVE_FLAMETHROWER, MOVE_HYPER_VOICE, MOVE_DARK_PULSE, MOVE_SUNNY_DAY}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31 ,31 ,31 ,31 ,31),
    .nature = TRAINER_PARTY_NATURE(NATURE_HARDY),
    ...
    .species = SPECIES_CAMERUPT,
    .ability = ABILITY_SHEER_FORCE,
    .moves = {MOVE_FLAMETHROWER, MOVE_EARTH_POWER, MOVE_ROCK_SLIDE, MOVE_CURSE}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31 ,31 ,31 ,31 ,31),
    .nature = TRAINER_PARTY_NATURE(NATURE_HARDY),
...
static const struct TrainerMon sParty_WinonaElite4[] = {
    {
    .iv = TRAINER_PARTY_IVS(31, 31 ,31 ,31 ,31 ,31),
    .nature = TRAINER_PARTY_NATURE(NATURE_HARDY),
    .heldItem = ITEM_NONE,
    ...
    .species = SPECIES_PELIPPER,
    .ability = ABILITY_KEEN_EYE,
    .moves = {MOVE_SURF, MOVE_AIR_SLASH, MOVE_TAILWIND, MOVE_ICE_BEAM}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31 ,31 ,31 ,31 ,31),
    .nature = TRAINER_PARTY_NATURE(NATURE_HARDY),
    ...
    .species = SPECIES_STARAPTOR,
    .ability = ABILITY_INTIMIDATE,
    .moves = {MOVE_CLOSE_COMBAT, MOVE_TAKE_DOWN, MOVE_DUAL_WINGBEAT, MOVE_ROOST}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31 ,31 ,31 ,31 ,31),
    .nature = TRAINER_PARTY_NATURE(NATURE_HARDY),
...
static const struct TrainerMon sParty_TateElite4[] = {
    {
    .iv = TRAINER_PARTY_IVS(31, 31 ,31 ,31 ,31 ,31),
    .nature = TRAINER_PARTY_NATURE(NATURE_HARDY),
    .heldItem = ITEM_NONE,
    ...
    .species = SPECIES_MALAMAR,
    .ability = ABILITY_CONTRARY,
    .moves = {MOVE_PSYCHO_CUT, MOVE_LUNGE, MOVE_SUPERPOWER, MOVE_LASH_OUT}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31 ,31 ,31 ,31 ,31),
    .nature = TRAINER_PARTY_NATURE(NATURE_HARDY),
    ...
    .species = SPECIES_GRUMPIG,
    .ability = ABILITY_THICK_FAT,
    .moves = {MOVE_PSYCHIC, MOVE_TEETER_DANCE, MOVE_POWER_GEM, MOVE_ENERGY_BALL}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31 ,31 ,31 ,31 ,31),
    .nature = TRAINER_PARTY_NATURE(NATURE_HARDY),
    ...
    .species = SPECIES_SOLROCK,
    .ability = ABILITY_LEVITATE,
    .moves = {MOVE_STONE_EDGE, MOVE_ZEN_HEADBUTT, MOVE_COSMIC_POWER, MOVE_FLARE_BLITZ}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31 ,31 ,31 ,31 ,31),
    .nature = TRAINER_PARTY_NATURE(NATURE_HARDY),
    ...
    .species = SPECIES_CLAYDOL,
    .ability = ABILITY_LEVITATE,
    .moves = {MOVE_PSYCHIC, MOVE_EXPLOSION, MOVE_EARTH_POWER, MOVE_SHADOW_BALL}
    }
};

static const struct TrainerMon sParty_JuanElite4[] = {
    {
    .iv = TRAINER_PARTY_IVS(31, 31 ,31 ,31 ,31 ,31),
    .nature = TRAINER_PARTY_NATURE(NATURE_HARDY),
    .heldItem = ITEM_NONE,
    ...
    .species = SPECIES_WHISCASH,
    .ability = ABILITY_HYDRATION,
    .moves = {MOVE_MUDDY_WATER, MOVE_EARTHQUAKE, MOVE_ZEN_HEADBUTT, MOVE_DRAGON_DANCE}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31 ,31 ,31 ,31 ,31),
    .nature = TRAINER_PARTY_NATURE(NATURE_HARDY),
    ...
    .species = SPECIES_CRAWDAUNT,
    .ability = ABILITY_HYPER_CUTTER,
    .moves = {MOVE_CRABHAMMER, MOVE_CRUNCH, MOVE_SWORDS_DANCE, MOVE_X_SCISSOR}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31 ,31 ,31 ,31 ,31),
    .nature = TRAINER_PARTY_NATURE(NATURE_HARDY),
    ...
    .species = SPECIES_LUDICOLO,
    .ability = ABILITY_SWIFT_SWIM,
    .moves = {MOVE_ENERGY_BALL, MOVE_ICE_BEAM, MOVE_SURF, MOVE_RAIN_DANCE}
    }
};

static const struct TrainerMon sParty_SidneyElite4[] = {
    {
    .iv = TRAINER_PARTY_IVS(31, 31 ,31 ,31 ,31 ,31),
    .nature = TRAINER_PARTY_NATURE(NATURE_HARDY),
    .heldItem = ITEM_NONE,
    ...
    .species = SPECIES_TYRANITAR,
    .ability = ABILITY_SAND_STREAM,
    .moves = {MOVE_STONE_EDGE, MOVE_EARTHQUAKE, MOVE_CRUNCH, MOVE_FLAMETHROWER}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31 ,31 ,31 ,31 ,31),
    .nature = TRAINER_PARTY_NATURE(NATURE_HARDY),
...
static const struct TrainerMon sParty_PhoebeElite4[] = {
    {
    .iv = TRAINER_PARTY_IVS(31, 31 ,31 ,31 ,31 ,31),
    .nature = TRAINER_PARTY_NATURE(NATURE_HARDY),
    .heldItem = ITEM_NONE,
    ...
    .species = SPECIES_TREVENANT,
    .ability = ABILITY_NATURAL_CURE,
    .moves = {MOVE_PHANTOM_FORCE, MOVE_SKITTER_SMACK, MOVE_HORN_LEECH, MOVE_WILL_O_WISP}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31 ,31 ,31 ,31 ,31),
    .nature = TRAINER_PARTY_NATURE(NATURE_HARDY),
    ...
    .species = SPECIES_SABLEYE,
    .ability = ABILITY_PRANKSTER,
    .moves = {MOVE_FOUL_PLAY, MOVE_SHADOW_CLAW, MOVE_NIGHT_SHADE, MOVE_THUNDER_WAVE}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31 ,31 ,31 ,31 ,31),
    .nature = TRAINER_PARTY_NATURE(NATURE_HARDY),
    ...
    .species = SPECIES_DUSKNOIR,
    .ability = ABILITY_PRESSURE,
    .moves = {MOVE_SHADOW_PUNCH, MOVE_THUNDER_PUNCH, MOVE_ICE_PUNCH, MOVE_FIRE_PUNCH}
    }
};

static const struct TrainerMon sParty_GlaciaElite4[] = {
    {
    .iv = TRAINER_PARTY_IVS(31, 31 ,31 ,31 ,31 ,31),
    .nature = TRAINER_PARTY_NATURE(NATURE_HARDY),
    .heldItem = ITEM_NONE,
    ...
    .species = SPECIES_MR_RIME,
    .ability = ABILITY_TANGLED_FEET,
    .moves = {MOVE_ICE_BEAM, MOVE_PSYCHIC, MOVE_DAZZLING_GLEAM, MOVE_SNOWSCAPE}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31 ,31 ,31 ,31 ,31),
    .nature = TRAINER_PARTY_NATURE(NATURE_HARDY),
    ...
    .species = SPECIES_DARMANITAN_GALARIAN,
    .ability = ABILITY_ZEN_MODE,
    .moves = {MOVE_ICE_PUNCH, MOVE_SUPERPOWER, MOVE_FIRE_PUNCH, MOVE_ZEN_HEADBUTT}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31 ,31 ,31 ,31 ,31),
    .nature = TRAINER_PARTY_NATURE(NATURE_HARDY),
    ...
    .species = SPECIES_CRABOMINABLE,
    .ability = ABILITY_IRON_FIST,
    .moves = {MOVE_ICE_HAMMER, MOVE_BRICK_BREAK, MOVE_THUNDER_PUNCH, MOVE_ROCK_SLIDE}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31 ,31 ,31 ,31 ,31),
    .nature = TRAINER_PARTY_NATURE(NATURE_HARDY),
    ...
    .species = SPECIES_GLALIE,
    .ability = ABILITY_REFRIGERATE,
    .moves = {MOVE_FREEZE_DRY, MOVE_DOUBLE_EDGE, MOVE_CRUNCH, MOVE_EARTHQUAKE}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31 ,31 ,31 ,31 ,31),
    .nature = TRAINER_PARTY_NATURE(NATURE_HARDY),
    ...
    .species = SPECIES_WALREIN,
    .ability = ABILITY_THICK_FAT,
    .moves = {MOVE_BLIZZARD, MOVE_SURF, MOVE_REST, MOVE_BODY_SLAM}
    }
};

static const struct TrainerMon sParty_ErikaElite4[] = {
    {
    .iv = TRAINER_PARTY_IVS(31, 31 ,31 ,31 ,31 ,31),
    .nature = TRAINER_PARTY_NATURE(NATURE_HARDY),
    .heldItem = ITEM_NONE,
    ...
    .species = SPECIES_TANGROWTH,
    .ability = ABILITY_CHLOROPHYLL,
    .moves = {MOVE_POWER_WHIP, MOVE_ANCIENT_POWER, MOVE_BODY_SLAM, MOVE_EARTHQUAKE}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31 ,31 ,31 ,31 ,31),
    .nature = TRAINER_PARTY_NATURE(NATURE_HARDY),
    ...
    .species = SPECIES_VENUSAUR,
    .ability = ABILITY_OVERGROW,
    .moves = {MOVE_ENERGY_BALL, MOVE_WEATHER_BALL, MOVE_SLUDGE_BOMB, MOVE_SUNNY_DAY}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31 ,31 ,31 ,31 ,31),
    .nature = TRAINER_PARTY_NATURE(NATURE_HARDY),
...
static const struct TrainerMon sParty_DrakeElite4[] = {
    {
    .iv = TRAINER_PARTY_IVS(31, 31 ,31 ,31 ,31 ,31),
    .nature = TRAINER_PARTY_NATURE(NATURE_HARDY),
    .heldItem = ITEM_NONE,
    ...
    .species = SPECIES_DRAGALGE,
    .ability = ABILITY_POISON_POINT,
    .moves = {MOVE_HYDRO_PUMP, MOVE_SLUDGE_WAVE, MOVE_TOXIC, MOVE_DRAGON_PULSE}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31 ,31 ,31 ,31 ,31),
    .nature = TRAINER_PARTY_NATURE(NATURE_HARDY),
    ...
    .species = SPECIES_TURTONATOR,
    .ability = ABILITY_SHELL_ARMOR,
    .moves = {MOVE_SHELL_TRAP, MOVE_DRAGON_PULSE, MOVE_IRON_TAIL, MOVE_REST}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31 ,31 ,31 ,31 ,31),
    .nature = TRAINER_PARTY_NATURE(NATURE_HARDY),
    ...
    .species = SPECIES_TYRANTRUM,
    .ability = ABILITY_STRONG_JAW,
    .moves = {MOVE_DRAGON_CLAW, MOVE_STONE_EDGE, MOVE_CRUNCH, MOVE_PSYCHIC_FANGS}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31 ,31 ,31 ,31 ,31),
    .nature = TRAINER_PARTY_NATURE(NATURE_HARDY),
    ...
    .species = SPECIES_FLYGON,
    .ability = ABILITY_LEVITATE,
    .moves = {MOVE_DRAGON_RUSH, MOVE_EARTHQUAKE, MOVE_BUG_BUZZ, MOVE_BOOMBURST}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31 ,31 ,31 ,31 ,31),
    .nature = TRAINER_PARTY_NATURE(NATURE_HARDY),
...
static const struct TrainerMon sParty_GiovanniElite4[] = {
    {
    .iv = TRAINER_PARTY_IVS(31, 31 ,31 ,31 ,31 ,31),
    .nature = TRAINER_PARTY_NATURE(NATURE_HARDY),
    .heldItem = ITEM_NONE,
    ...
    .species = SPECIES_MAROWAK,
    .ability = ABILITY_BATTLE_ARMOR,
    .moves = {MOVE_BONEMERANG, MOVE_THROAT_CHOP, MOVE_ROCK_CLIMB, MOVE_OUTRAGE}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31 ,31 ,31 ,31 ,31),
    .nature = TRAINER_PARTY_NATURE(NATURE_HARDY),
    ...
    .species = SPECIES_SEISMITOAD,
    .ability = ABILITY_POISON_TOUCH,
    .moves = {MOVE_MUDDY_WATER, MOVE_DRAIN_PUNCH, MOVE_BOUNCE, MOVE_EARTHQUAKE}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31 ,31 ,31 ,31 ,31),
    .nature = TRAINER_PARTY_NATURE(NATURE_HARDY),
    ...
    .species = SPECIES_RHYPERIOR,
    .ability = ABILITY_ROCK_HEAD,
    .moves = {MOVE_ROCK_WRECKER, MOVE_EARTHQUAKE, MOVE_TAKE_DOWN, MOVE_MEGAHORN}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31 ,31 ,31 ,31 ,31),
    .nature = TRAINER_PARTY_NATURE(NATURE_HARDY),
    ...
    .species = SPECIES_NIDOKING,
    .ability = ABILITY_SHEER_FORCE,
    .moves = {MOVE_EARTH_POWER, MOVE_SLUDGE_BOMB, MOVE_MEGAHORN, MOVE_SMART_STRIKE}
    }
};

static const struct TrainerMon sParty_KogaElite4[] = {
    {
    .iv = TRAINER_PARTY_IVS(31, 31 ,31 ,31 ,31 ,31),
    .nature = TRAINER_PARTY_NATURE(NATURE_HARDY),
    .heldItem = ITEM_NONE,
    ...
    .species = SPECIES_WEEZING,
    .ability = ABILITY_LEVITATE,
    .moves = {MOVE_SLUDGE_BOMB, MOVE_HEAT_WAVE, MOVE_DOUBLE_HIT, MOVE_TOXIC}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31 ,31 ,31 ,31 ,31),
    .nature = TRAINER_PARTY_NATURE(NATURE_HARDY),
    ...
    .species = SPECIES_SKUNTANK,
    .ability = ABILITY_AFTERMATH,
    .moves = {MOVE_POISON_JAB, MOVE_NIGHT_SLASH, MOVE_PLAY_ROUGH, MOVE_FLAMETHROWER}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31 ,31 ,31 ,31 ,31),
    .nature = TRAINER_PARTY_NATURE(NATURE_HARDY),
    ...
    .species = SPECIES_CROBAT,
    .ability = ABILITY_INNER_FOCUS,
    .moves = {MOVE_CROSS_POISON, MOVE_ACROBATICS, MOVE_LEECH_LIFE, MOVE_CONFUSE_RAY}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31 ,31 ,31 ,31 ,31),
    .nature = TRAINER_PARTY_NATURE(NATURE_HARDY),
    ...
    .species = SPECIES_MUK,
    .ability = ABILITY_POISON_TOUCH,
    .moves = {MOVE_GUNK_SHOT, MOVE_THUNDER_PUNCH, MOVE_DRAIN_PUNCH, MOVE_LUNGE}
    }
};

static const struct TrainerMon sParty_StevenElite4[] = {
    {
    .iv = TRAINER_PARTY_IVS(31, 31 ,31 ,31 ,31 ,31),
    .nature = TRAINER_PARTY_NATURE(NATURE_HARDY),
    .heldItem = ITEM_NONE,
    ...
    .species = SPECIES_COPPERAJAH,
    .ability = ABILITY_HEAVY_METAL,
    .moves = {MOVE_SUPERPOWER, MOVE_HEAVY_SLAM, MOVE_HIGH_HORSEPOWER, MOVE_PLAY_ROUGH}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31 ,31 ,31 ,31 ,31),
    .nature = TRAINER_PARTY_NATURE(NATURE_HARDY),
    ...
    .species = SPECIES_FERROTHORN,
    .ability = ABILITY_IRON_BARBS,
    .moves = {MOVE_GYRO_BALL, MOVE_CURSE, MOVE_POWER_WHIP, MOVE_BODY_PRESS}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31 ,31 ,31 ,31 ,31),
    .nature = TRAINER_PARTY_NATURE(NATURE_HARDY),
    ...
    .species = SPECIES_AGGRON,
    .ability = ABILITY_STURDY,
    .moves = {MOVE_ROCK_CLIMB, MOVE_IRON_TAIL, MOVE_DRAGON_RUSH, MOVE_AUTOTOMIZE}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31 ,31 ,31 ,31 ,31),
    .nature = TRAINER_PARTY_NATURE(NATURE_HARDY),
    ...
    .species = SPECIES_METAGROSS,
    .ability = ABILITY_CLEAR_BODY,
    .moves = {MOVE_ZEN_HEADBUTT, MOVE_METEOR_MASH, MOVE_EARTHQUAKE, MOVE_HAMMER_ARM}
    }
};

static const struct TrainerMon sParty_BugsyElite4[] = {
    {
    .iv = TRAINER_PARTY_IVS(31, 31 ,31 ,31 ,31 ,31),
    .nature = TRAINER_PARTY_NATURE(NATURE_HARDY),
    .heldItem = ITEM_NONE,
    ...
    .species = SPECIES_PINSIR,
    .ability = ABILITY_MOLD_BREAKER,
    .moves = {MOVE_SUPERPOWER, MOVE_EARTHQUAKE, MOVE_X_SCISSOR, MOVE_ROCK_CLIMB}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31 ,31 ,31 ,31 ,31),
    .nature = TRAINER_PARTY_NATURE(NATURE_HARDY),
    ...
    .species = SPECIES_VENOMOTH,
    .ability = ABILITY_TINTED_LENS,
    .moves = {MOVE_BUG_BUZZ, MOVE_PSYCHIC, MOVE_SLUDGE_BOMB, MOVE_QUIVER_DANCE}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31 ,31 ,31 ,31 ,31),
    .nature = TRAINER_PARTY_NATURE(NATURE_HARDY),
    ...
    .species = SPECIES_SCYTHER,
    .ability = ABILITY_TECHNICIAN,
    .moves = {MOVE_DUAL_WINGBEAT, MOVE_NIGHT_SLASH, MOVE_U_TURN, MOVE_STEEL_WING}
    }
};

static const struct TrainerMon sParty_ValerieElite4[] = {
    {
    .iv = TRAINER_PARTY_IVS(31, 31 ,31 ,31 ,31 ,31),
    .nature = TRAINER_PARTY_NATURE(NATURE_HARDY),
    .heldItem = ITEM_NONE,
    ...
    .species = SPECIES_CLEFABLE,
    .ability = ABILITY_MAGIC_GUARD,
    .moves = {MOVE_MOONBLAST, MOVE_FLAMETHROWER, MOVE_THUNDERBOLT, MOVE_ICE_BEAM}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31 ,31 ,31 ,31 ,31),
    .nature = TRAINER_PARTY_NATURE(NATURE_HARDY),
