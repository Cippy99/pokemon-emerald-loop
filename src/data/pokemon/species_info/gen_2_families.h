...
const struct SpeciesInfo gSpeciesInfoGen2[] =
{
    ...
    [SPECIES_QUILAVA] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 36, SPECIES_TYPHLOSION},
                                {EVO_ITEM_HOLD_LEVEL, ITEM_SPELL_TAG, SPECIES_TYPHLOSION_HISUIAN}),
    },
    ...
    [SPECIES_ARIADOS] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_SWARM, ABILITY_SHARPNESS, ABILITY_SNIPER },
        .bodyColor = BODY_COLOR_RED,
...
#define TOGEPI_FAMILY_TYPE (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_NORMAL)
    ...
    [SPECIES_TOGEPI] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 17, SPECIES_TOGETIC}),
    },
...
#define AMPHAROS_DEFENSE (P_UPDATED_STATS >= GEN_6 ? 85 : 75)
    ...
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_CHLOROBOOST, ABILITY_SOLAR_POWER, ABILITY_SEED_SOWER },
    #else
    ...
    [SPECIES_SUNFLORA] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_GRASS),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_CHLOROBOOST, ABILITY_NONE, ABILITY_SEED_SOWER },
    #else
        .abilities = { ABILITY_CHLOROPHYLL, ABILITY_NONE, ABILITY_EARLY_BIRD },
    #endif
        .bodyColor = BODY_COLOR_YELLOW,
