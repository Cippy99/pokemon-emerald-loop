...
const u8 gText_ShowLevelCap[] = _("Current level cap is {STR_VAR_1}.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_AbilityCapsule[] = _("Ability Capsule");
const u8 gText_AbilityPatch[] = _("Ability Patch");
...
//Difficulty Menu
const u8 gText_EasyDiff[] = _("EASY");
const u8 gText_NormalDiff[] = _("NORMAL");
const u8 gText_HardDiff[] = _("HARD");
