const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_PIKACHU]               = {{EVO_ITEM, ITEM_THUNDER_STONE, SPECIES_RAICHU},
                                       {EVO_ITEM_HOLD, ITEM_THUNDER_STONE, SPECIES_RAICHU_ALOLAN}},
    ...
    [SPECIES_EXEGGCUTE]             = {{EVO_ITEM, ITEM_LEAF_STONE, SPECIES_EXEGGUTOR},
                                       {EVO_ITEM_HOLD, ITEM_LEAF_STONE, SPECIES_EXEGGUTOR_ALOLAN}},
    ...
    [SPECIES_KOFFING]               = {{EVO_LEVEL, 35, SPECIES_WEEZING},
                                       {EVO_ITEM_HOLD_LEVEL, ITEM_PIXIE_PLATE, SPECIES_WEEZING_GALARIAN}},
    ...
    [SPECIES_TOGEPI]                = {{EVO_LEVEL, 17, SPECIES_TOGETIC}},
#if P_GEN_4_POKEMON == TRUE
    ...
    [SPECIES_SPHEAL]                = {{EVO_LEVEL, 27, SPECIES_SEALEO}},
    ...
    [SPECIES_BUNEARY]               = {{EVO_LEVEL, 32, SPECIES_LOPUNNY}},
    ...
    [SPECIES_WOOBAT]                = {{EVO_LEVEL, 22, SPECIES_SWOOBAT}},
    ...
    [SPECIES_PETILIL]               = {{EVO_ITEM, ITEM_SUN_STONE, SPECIES_LILLIGANT},
                                       {EVO_ITEM_HOLD, ITEM_SUN_STONE, SPECIES_LILLIGANT_HISUIAN}},
    ...
    [SPECIES_KLINK]                 = {{EVO_LEVEL, 33, SPECIES_KLANG}},
    [SPECIES_KLANG]                 = {{EVO_LEVEL, 44, SPECIES_KLINKLANG}},
    ...
    [SPECIES_GOLETT]                = {{EVO_LEVEL, 37, SPECIES_GOLURK}},
    [SPECIES_PAWNIARD]              = {{EVO_LEVEL, 39, SPECIES_BISHARP}},
    ...
    [SPECIES_LARVESTA]              = {{EVO_LEVEL, 52, SPECIES_VOLCARONA}},
#endif
#if P_GEN_6_POKEMON == TRUE
