...
#define EVO_MOVE_TWO_SEGMENT              44     // Pokémon levels up, knows specified move, has a personality value with a modulus of 0
#define EVO_MOVE_THREE_SEGMENT            45     // Pokémon levels up, knows specified move, has a personality value with a modulus of 1-99
#define EVO_LEVEL_FAMILY_OF_THREE         46     // Pokémon reaches the specified level with a personality value with a modulus of 0
#define EVO_LEVEL_FAMILY_OF_FOUR          47     // Pokémon reaches the specified level with a personality value with a modulus of 1-99
...
#define HIDDEN_ABILITY_CHANCE 20
