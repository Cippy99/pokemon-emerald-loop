...
COMMON_DATA rng_value_t gRngCustomValue = {0};
...
u32 RandomCustom_32(void)
{
    return _SFC32_Next_Stream(&gRngCustomValue, STREAM_CUSTOM);
}
...
void SeedRngCustom(u32 seed)
{
    SFC32_Seed(&gRngCustomValue, seed, STREAM_CUSTOM);
}
